						...
						<div class="padding-top-90 grid-item-50-50-100 js-isotope-grid-item">
							...
							<div class="grid-margin-box text-right js-scrollanim">
								<div class="anim-fade">
									...
									<p class="body-text-xs text-color-black margin-top-20">We help our clients in building Brand Website, Corporate Website, Catalogue Website, E-commerce Website and Comprehensive portal. Our young and energetic. Team of Techies help to bring the most dynamic Custom Website Designing Services to our clients.</p>
								</div>
						...
						<div class="padding-top-90 grid-item-50-50-100 js-isotope-grid-item">
							...
							<div class="grid-margin-box js-scrollanim">
								<div class="anim-fade">
									...
									<p class="body-text-xs text-color-black margin-top-20">We carefully understand your products, your customers and your business processes and then bring a comprehensive e-commerce solution customized to your business requirements.</p>
								</div>
							</div><!-- grid-margin-box end -->
						</div><!-- grid-item end -->
					</div><!-- column end -->
                          </div><!-- flex-container end -->
                         <div class="pos-rel section-bg-dark-2 padding-top-bottom-120">
				<img class="pos-rel bg-img-cover height-100vh" src="assets/images/backgrounds/website development process.png" alt="development">	
				</div>
  		</section><!-- about end -->
