...
<html lang="en">
    ...
    <title>Website Design & Development Services | D'genius Solutions</title>
    <meta name="description" content="We help our clients in building brand website, corporate website, catalogue website, E-commerce website and much more." />
    <meta name="keywords" content="website design company in mumbai, web design company in mumbai, web development company in mumbai, website developers in mumbai, website development company in dubai, web development services in dubai, web development companies in ahmedabad, web design company in ahmedabad, web design ahmedabad" />
				...
				<div class="lines-container pos-rel anim-lines flex-min-height-100vh">
					...
					<div class="padding-top-bottom-120 width-100perc">
						...
						<h1 class="headline-xxxl text-center after-preloader-anim">
							<span class="anim-text-fill" data-text="Website Design">Website Design</span>
							<span class="anim-text-fill tr-delay-02" data-text="Development">Development</span>
						</h1><!-- title end -->
					...
					<div class="four-columns column-100-100 padding-top-90">
						<div class="line-col-l-r-margin-20">
							...
							<h2 class="headline-s js-scrollanim js-scrollanim-active">
								<span class="text-color-black">Website Design</span>
								<br>
								<span class="text-color-black tr-delay-01">Development</span>
								</h2><!-- title end -->
							</div>
					</div><!-- column end -->
					<!-- column start -->
						...
						<div class="padding-top-90 grid-item-50-50-100 js-isotope-grid-item">
							...
							<div class="grid-margin-box js-scrollanim">
								<div class="anim-fade">
									...
									<h3 class="headline-xxs text-color-black margin-top-30">Website Development</h3>
									<p class="body-text-xs text-color-black margin-top-20"> Our young and energetic Team of Techies help to bring the most dynamic Custom Website Designing Services to our clients.<br>
                                                                         We help our clients in building</p>
                                                                         <ul class="list text-color-black margin-top-30 js-scrollanim">
									<li class="list__item red dot hidden-box">
										<div class="body-text-s anim-slide">Brand Website</div>
									</li>
									<li class="list__item red dot hidden-box">
										<div class="body-text-s anim-slide tr-delay-01">Corporate Website</div>
									</li>
									<li class="list__item red dot hidden-box">
										<div class="body-text-s anim-slide tr-delay-02">Catalogue Website</div>
									</li>
									<li class="list__item red dot hidden-box">
										<div class="body-text-s anim-slide tr-delay-03">E-commerce Website</div>
									</li>
									<li class="list__item red dot hidden-box">
										<div class="body-text-s anim-slide tr-delay-04">Comprehensive portal</div>
									</li>
									</ul><!-- list end -->  
								</div>
						...
						<div class="padding-top-90 grid-item-50-50-100 js-isotope-grid-item">
							...
							<div class="grid-margin-box js-scrollanim">
								<div class="anim-fade">
									...
									<h3 class="headline-xxs text-color-black margin-top-30">E-commerce Development</h3>
									<p class="body-text-xs text-color-black margin-top-20">We carefully understand your products, your customers and your business processes and then bring a comprehensive e-commerce solution customized to your business requirements. We hand in hand work with e-commerce advertising strategy to drive sales to your site through paid traffic conversion funnel.</p>
								</div>
							</div><!-- grid-margin-box end -->
						</div><!-- grid-item end -->
					</div><!-- column end -->
