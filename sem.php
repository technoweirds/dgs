				...
				<div class="lines-container pos-rel anim-lines flex-min-height-100vh">
					...
					<div class="padding-top-bottom-120 width-100perc">
						...
						<h2 class="headline-xxxl text-center after-preloader-anim">
							<span class="anim-text-fill" data-text="Search Engine">Search Engine</span><br>
							<span class="anim-text-fill tr-delay-01" data-text="Marketing (SEM)">Marketing (SEM)</span>
								</h2><!-- title end -->
					...
					<div class="four-columns column-100-100 padding-top-90">
						<div class="line-col-l-r-margin-20">
							...
							<h2 class="headline-s js-scrollanim js-scrollanim-active">
								<span class="text-color-black">Search Engine</span>
								<br>
								<span class="text-color-black tr-delay-01">Marketing (SEM)</span>
								</h2><!-- title end -->
							</div>
					</div><!-- column end -->
					<!-- column start -->
						...
						<div class="padding-top-90 grid-item-50-50-100 js-isotope-grid-item">
							...
							<div class="grid-margin-box text-right js-scrollanim">
								<div class="anim-fade">
									...
									<h3 class="headline-xxs text-color-black margin-top-30">Search Engine Marketing (SEM)</h3>
									<p class="body-text-xs text-color-black margin-top-20">We help to define your objective and achieve your goals. We do paid promotion of brands on Search Engines, Social Media channels, YouTube & Affiliated partners like Taboola.</p>
								</div>
						...
						<div class="padding-top-90 grid-item-50-50-100 js-isotope-grid-item">
							...
							<div class="grid-margin-box js-scrollanim">
								<div class="anim-fade">
									...
									<h3 class="headline-xxs text-color-black margin-top-30">Search Engine Optimization</h3>
									<p class="body-text-xs text-color-black margin-top-20">We specialize in developing search campaigns that deliver visibility, traffic, rankings & conversions. With well-researched, strategic and brand specific Search Engine Optimization, we help resurrect your brand and elevate your online presence. Be it Keyword research, On-page optimization, Off-page optimization, Link building, Submissions or Content generation, we leave no stone unturned.</p>
								</div>
							</div><!-- grid-margin-box end -->
						</div><!-- grid-item end -->
						...
						<div class="padding-top-90 grid-item-50-50-100 js-isotope-grid-item">
							...
							<div class="grid-margin-box text-right js-scrollanim">
								<div class="anim-fade">
									...
									<h3 class="headline-xxs text-color-black margin-top-30">Pay Per Click (PPC)</h3>
									<p class="body-text-xs text-color-black margin-top-20">After studying your business goals and your competitors,our experts will come up with he proper PPC plan & execution strategy. After strategy, we will implement our focused keywords into well-organized campaigns and ad groups.</p>
								</div>
							</div><!-- grid-margin-box end -->
						</div><!-- grid-item end -->
						...
						<div class="padding-top-90 grid-item-50-50-100 js-isotope-grid-item">
							...
							<div class="grid-margin-box js-scrollanim">
								<div class="anim-fade">
									...
									<h3 class="headline-xxs text-color-black margin-top-30">Monitoring & Reporting</h3>
									<p class="body-text-xs text-color-black margin-top-20">We create and provide full analytic reports, revenue reports, campaign, conversion so he performance can be attributed to PPC investment.</p>
								</div>
								</div><!-- grid-margin-box end -->
						</div><!-- grid-item end -->
					</div><!-- column end -->
