...
<!-- End Google Tag Manager (noscript) -->
		...
		<main class="js-animsition-overlay" data-animsition-overlay="true">
			<!-- pos-rel start -->
			<section id="up" class="pos-rel js-parallax-bg" style="background-image:url(assets/images/backgrounds/photo-of-person-using-laptop-3751699.jpg)">
				<!-- bg-overlay -->
				<div class="bg-overlay-black"></div>
				<!-- pos-rel start -->
				<div class="pos-rel flex-min-height-100vh">
					<div class="padding-top-bottom-120 width-100perc">
						...
						<h2 class="headline-xxxxl text-center hidden-box after-preloader-anim">
							<span class="anim-slide">Blog Sliders</span>
						</h2><!-- title end -->
					</div>
				</div><!-- pos-rel end -->
			</section><!-- pos-rel end -->
			...
			<section id="down" class="pos-rel section-bg-dark-2">
				...
				<div class="pos-rel padding-top-bottom-120">
					...
					<h2 class="headline-l text-center js-scrollanim">
						<span class="anim-text-double-fill invert" data-text="Featured">Featured</span>
						<span class="anim-text-double-fill invert tr-delay-02" data-text="Articles">Articles</span>
					</h2><!-- title end -->
						...
						<div class="swiper-wrapper js-slider-scroll-anim">
							...
							<article class="swiper-slide">
								<div class="anim-img-scale">
									<a href="post_dont-panic.html" class="d-block hover-box js-animsition-link js-pointer-large">
										...
										<h3 class="headline-xxxs pos-abs pos-left-bottom hover-move-right">
									...
									<ul class="pos-abs pos-left-top list list_row list_margin-30px">
										<li class="list__item">
											<a href="#" class="subhead-xxs anim-text-fill tr-delay-04 js-pointer-small" data-text="By: Nick Hufnagel">By: Nick Hufnagel</a>
										</li>
										<li class="list__item">
											<a href="#" class="subhead-xxs anim-text-fill tr-delay-05 js-pointer-small" data-text="In: Art">In: Art</a>
										</li>
										<li class="list__item">
											<a href="#" class="subhead-xxs anim-text-fill tr-delay-06 js-pointer-small" data-text="2020, April 28">2020, April 28</a>
										</li>
									</ul>
								</div>
							...
							<article class="swiper-slide">
								<div class="anim-img-scale">
									...
									<ul class="pos-abs pos-left-top list list_row list_margin-30px">
										<li class="list__item">
											<a href="#" class="subhead-xxs anim-text-fill tr-delay-04 js-pointer-small" data-text="By: Jeffery Reder">By: Jeffery Reder</a>
										</li>
										<li class="list__item">
											<a href="#" class="subhead-xxs anim-text-fill tr-delay-05 js-pointer-small" data-text="In: Art">In: Art</a>
										</li>
										<li class="list__item">
											<a href="#" class="subhead-xxs anim-text-fill tr-delay-06 js-pointer-small" data-text="2020, April 29">2020, April 29</a>
										</li>
									</ul>
								</div>
							</article><!-- swiper-slide end -->
							...
							<article class="swiper-slide">
								<div class="anim-img-scale">
									...
									<ul class="pos-abs pos-left-top list list_row list_margin-30px">
										...
										<li class="list__item">
											<a href="#" class="subhead-xxs anim-text-fill tr-delay-05 js-pointer-small" data-text="In: Culture">In: Culture</a>
										</li>
										<li class="list__item">
											<a href="#" class="subhead-xxs anim-text-fill tr-delay-06 js-pointer-small" data-text="2020, April 30">2020, April 30</a>
										</li>
									</ul>
								</div>
							</article><!-- swiper-slide end -->
							...
							<article class="swiper-slide">
								<div class="anim-img-scale">
									...
									<ul class="pos-abs pos-left-top list list_row list_margin-30px">
										...
										<li class="list__item">
											<a href="#" class="subhead-xxs anim-text-fill tr-delay-05 js-pointer-small" data-text="In: Design">In: Design</a>
										</li>
										<li class="list__item">
											<a href="#" class="subhead-xxs anim-text-fill tr-delay-06 js-pointer-small" data-text="2020, April 7">2020, April 7</a>
										</li>
									</ul>
								</div>
							</article><!-- swiper-slide end -->
							...
							<article class="swiper-slide">
								<div class="anim-img-scale">
									...
									<ul class="pos-abs pos-left-top list list_row list_margin-30px">
										<li class="list__item">
											<a href="#" class="subhead-xxs anim-text-fill tr-delay-04 js-pointer-small" data-text="By: Nancy Newton">By: Nancy Newton</a>
										</li>
										<li class="list__item">
											<a href="#" class="subhead-xxs anim-text-fill tr-delay-05 js-pointer-small" data-text="In: Art">In: Art</a>
										</li>
										<li class="list__item">
											<a href="#" class="subhead-xxs anim-text-fill tr-delay-06 js-pointer-small" data-text="2020, March 2">2020, March 2</a>
										</li>
									</ul>
								</div>
							</article><!-- swiper-slide end -->
				...
				<div class="pos-rel padding-top-bottom-120">
					...
					<div class="container small">
						<div class="text-center js-scrollanim">
							<h2 class="headline-l">
								<span class="anim-text-double-fill invert" data-text="Fresh">Fresh</span>
								<span class="anim-text-double-fill invert tr-delay-02" data-text="Topics">Topics</span>
							</h2>
							<p class="subhead-xs text-color-b0b0b0 margin-top-20 anim-fade tr-delay-03">Cloud bread cardigan messenger bag raw denim swag drinking vinegar. Yuccie jianbing bespoke retro, photo booth salvia. Helvetica hella vexillologist, prism lo-fi activated charcoal iPhone thundercats irony meggings meh cardigan chartreuse.</p>
						</div>
							...
							<div class="six-columns padding-top-30">
								<div class="column-l-margin-40 anim-fade js-scrollanim">
									...
									<a href="post_dont-panic.html" class="margin-top-bottom-30 d-block js-pointer-large js-animsition-link">
										<h3 class="headline-xxxs">Modern architecture and<br>design society</h3>
										<p class="body-text-xs margin-top-20">Plaid retro migas venmo lo-fi ethical artisan fingerstache seitan you probably haven't heard of them fam keffiyeh...</p>
									</a>
						...
						<article class="flex-container reverse flex-align-center padding-top-60">
							<div class="six-columns padding-top-30">
								<div class="column-r-margin-40 anim-fade js-scrollanim">
									<ul class="list list_row list_margin-30px">
										<li class="list__item">
											<a href="#" class="subhead-xxs text-color-8a8a8a text-hover-to-red js-pointer-small">By: Nick Hufnagel</a>
										</li>
										<li class="list__item">
											<a href="#" class="subhead-xxs text-color-8a8a8a text-hover-to-red js-pointer-small">In: Design</a>
										</li>
										<li class="list__item">
											<a href="#" class="subhead-xxs text-color-8a8a8a text-hover-to-red js-pointer-small">2020, April 7</a>
										</li>
									</ul>
									<a href="post_dont-panic.html" class="margin-top-bottom-30 d-block js-pointer-large js-animsition-link">
										<h3 class="headline-xxxs">Home recording studio<br>interior design</h3>
										<p class="body-text-xs margin-top-20">Plaid retro migas venmo lo-fi ethical artisan fingerstache seitan you probably haven't heard of them fam keffiyeh...</p>
									</a>
									<a href="post_dont-panic.html" class="skew-btn js-pointer-large js-animsition-link">
										<span class="skew-btn__box">
							...
							<div class="six-columns padding-top-30">
								<a href="post_dont-panic.html" class="d-block hover-box anim-img-reveal js-scrollanim js-pointer-large js-animsition-link">
									<div class="anim-img-reveal__hidden">
										<div class="anim-img-reveal__scale">
											<img class="img-hover-scale" src="assets/images/posts/home-studio/pexels-3355420-2.jpg" alt="Post">
										</div>
									</div>
								</a>
							</div>
						...
						<article class="flex-container flex-align-center padding-top-60">
							...
							<div class="six-columns padding-top-30">
								<div class="column-l-margin-40 anim-fade js-scrollanim">
									<ul class="list list_row list_margin-30px">
										<li class="list__item">
											<a href="#" class="subhead-xxs text-color-8a8a8a text-hover-to-red js-pointer-small">By: Jeffery Reder</a>
										</li>
										<li class="list__item">
											<a href="#" class="subhead-xxs text-color-8a8a8a text-hover-to-red js-pointer-small">In: Design</a>
										</li>
										<li class="list__item">
											<a href="#" class="subhead-xxs text-color-8a8a8a text-hover-to-red js-pointer-small">2020, April 12</a>
										</li>
									</ul>
									<a href="post_dont-panic.html" class="margin-top-bottom-30 d-block js-pointer-large js-animsition-link">
										<h3 class="headline-xxxs">Second hand photography<br>studio equipment</h3>
										<p class="body-text-xs margin-top-20">Plaid retro migas venmo lo-fi ethical artisan fingerstache seitan you probably haven't heard of them fam keffiyeh...</p>
									</a>
									<a href="post_dont-panic.html" class="skew-btn js-pointer-large js-animsition-link">
										<span class="skew-btn__box">
							...
							<div class="six-columns padding-top-30">
								<div class="column-r-margin-40 anim-fade js-scrollanim">
									<ul class="list list_row list_margin-30px">
										...
										<li class="list__item">
											<a href="#" class="subhead-xxs text-color-8a8a8a text-hover-to-red js-pointer-small">2020, April 29</a>
										</li>
									</ul>
									<a href="post_dont-panic.html" class="margin-top-bottom-30 d-block js-pointer-large js-animsition-link">
										<h3 class="headline-xxxs">Colorful eyeshadow<br>makeup tutorial</h3>
										<p class="body-text-xs margin-top-20">Plaid retro migas venmo lo-fi ethical artisan fingerstache seitan you probably haven't heard of them fam keffiyeh...</p>
									</a>
									<a href="post_dont-panic.html" class="skew-btn js-pointer-large js-animsition-link">
										<span class="skew-btn__box">
							...
							<div class="six-columns padding-top-30">
								<div class="column-l-margin-40 anim-fade js-scrollanim">
									<ul class="list list_row list_margin-30px">
										...
										<li class="list__item">
											<a href="#" class="subhead-xxs text-color-8a8a8a text-hover-to-red js-pointer-small">In: Culture</a>
										</li>
										<li class="list__item">
											<a href="#" class="subhead-xxs text-color-8a8a8a text-hover-to-red js-pointer-small">2020, April 30</a>
										</li>
									</ul>
									<a href="post_dont-panic.html" class="margin-top-bottom-30 d-block js-pointer-large js-animsition-link">
										<h3 class="headline-xxxs">Insomnia symptoms<br>causes and treatment</h3>
										<p class="body-text-xs margin-top-20">Plaid retro migas venmo lo-fi ethical artisan fingerstache seitan you probably haven't heard of them fam keffiyeh...</p>
									</a>
									<a href="post_dont-panic.html" class="skew-btn js-pointer-large js-animsition-link">
										<span class="skew-btn__box">
			...
			<section class="pos-rel section-bg-dark-2">
				...
				<div class="pos-rel padding-top-bottom-120">
					<!-- title start -->
					<h2 class="headline-l text-center js-scrollanim">
						<span class="anim-text-double-fill invert" data-text="Recent">Recent</span>
						<span class="anim-text-double-fill invert tr-delay-02" data-text="Posts">Posts</span>
					</h2><!-- title end -->
					...
					<div class="js-2-view-slider padding-top-bottom-90 hidden-box pos-rel">
						...
						<div class="swiper-wrapper">
							<!-- swiper-slide start -->
							<article class="swiper-slide">
								<div class="hover-box hidden-box pos-rel margin-left-right-20">
									<a href="post_dont-panic.html" class="d-block js-animsition-link js-pointer-large">
										<img class="img-hover-scale" src="assets/images/posts/decor-and-furniture/man-seating-on-couch-1726074.jpg" alt="Post">
										<h3 class="headline-xxxs pos-abs pos-left-bottom hover-move-right">
											<span class="hidden-box d-block">
												<span class="anim-slide">Home decor and furniture</span>
											</span>
											<span class="hidden-box d-block">
												<span class="anim-slide tr-delay-01">stores near me</span>
											</span>
										</h3>
									</a>
									<ul class="pos-abs pos-left-top list list_row list_margin-30px">
							...
							<article class="swiper-slide">
								<div class="hover-box hidden-box pos-rel margin-left-right-20">
									<a href="post_dont-panic.html" class="d-block js-animsition-link js-pointer-large">
										<img class="img-hover-scale" src="assets/images/posts/home-studio/man-using-light-control-panel-3355358.jpg" alt="Post">
										<h3 class="headline-xxxs pos-abs pos-left-bottom hover-move-right">
											<span class="hidden-box d-block">
												<span class="anim-slide">Home recording studio</span>
											</span>
											<span class="hidden-box d-block">
												<span class="anim-slide tr-delay-01">interior design</span>
											</span>
										</h3>
									</a>
									<ul class="pos-abs pos-left-top list list_row list_margin-30px">
							...
							<article class="swiper-slide">
								<div class="hover-box hidden-box pos-rel margin-left-right-20">
									<a href="post_dont-panic.html" class="d-block js-animsition-link js-pointer-large">
										<img class="img-hover-scale" src="assets/images/posts/tattoo-artist/woman-in-pink-long-sleeve-shirt-wearing-eyeglasses-4125604-2.jpg" alt="Post">
										<h3 class="headline-xxxs pos-abs pos-left-bottom hover-move-right">
											<span class="hidden-box d-block">
												<span class="anim-slide">Tattoo artist</span>
											</span>
											<span class="hidden-box d-block">
												<span class="anim-slide tr-delay-01">apprenticeship portfolio</span>
											</span>
										</h3>
									</a>
									<ul class="pos-abs pos-left-top list list_row list_margin-30px">
							...
							<article class="swiper-slide">
								<div class="hover-box hidden-box pos-rel margin-left-right-20">
									<a href="post_dont-panic.html" class="d-block js-animsition-link js-pointer-large">
										<img class="img-hover-scale" src="assets/images/posts/colorful-eyeshadows/woman-wearing-black-leather-top-2712948-2.jpg" alt="Post">
										<h3 class="headline-xxxs pos-abs pos-left-bottom hover-move-right">
											<span class="hidden-box d-block">
												<span class="anim-slide">Colorful eyeshadow</span>
											</span>
											<span class="hidden-box d-block">
												<span class="anim-slide tr-delay-01">makeup tutorial</span>
											</span>
										</h3>
									</a>
									<ul class="pos-abs pos-left-top list list_row list_margin-30px">
							...
							<article class="swiper-slide">
								<div class="hover-box hidden-box pos-rel margin-left-right-20">
									<a href="post_dont-panic.html" class="d-block js-animsition-link js-pointer-large">
										<img class="img-hover-scale" src="assets/images/posts/insomnia/time-lapse-photography-of-person-on-tunnel-3162980.jpg" alt="Post">
										<h3 class="headline-xxxs pos-abs pos-left-bottom hover-move-right">
											<span class="hidden-box d-block">
												<span class="anim-slide">Insomnia symptoms</span>
											</span>
											<span class="hidden-box d-block">
												<span class="anim-slide tr-delay-01">causes and treatment</span>
											</span>
										</h3>
									</a>
									<ul class="pos-abs pos-left-top list list_row list_margin-30px">
