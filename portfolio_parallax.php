...
<!-- End Google Tag Manager (noscript) -->
		...
		<main class="js-animsition-overlay" data-animsition-overlay="true">
			...
			<section class="lines-section pos-rel anim-lines section-bg-dark-1 js-parallax-slider one-page-slider">
				...
				<div class="swiper-wrapper">
					...
					<div class="swiper-slide">
						...
						<div class="lines-container pos-rel no-lines d-flex flex-center-center height-100perc" data-swiper-parallax-y="60%">
							<!-- title start -->
							<h2 class="headline-xxxxl container small hidden-box">
								<a href="project_drone.html" class="anim-slide js-pointer-large js-animsition-link">Speakers</a>
							</h2><!-- title end -->

							<!-- portfolio-slider-details start -->
							<div class="flex-container portfolio-details">
								<div class="four-columns column-50-100 padding-bottom-1 text-center">
									<span class="hidden-box d-inline-block">
										<span class="subhead-xxs anim-reveal">Photoshoot</span>
									</span>
								</div>
								<div class="four-columns column-50-100 padding-bottom-1 text-center">
									<span class="hidden-box d-inline-block">
										<span class="subhead-xxs anim-reveal tr-delay-02">Marketing</span>
									</span>
								</div>
								<div class="four-columns column-50-100 padding-bottom-1 text-center">
									<span class="hidden-box d-inline-block">
										<span class="subhead-xxs anim-reveal tr-delay-04">Paris 2020</span>
									</span>
								</div>
							</div><!-- portfolio-slider-details end -->

							<!-- button start -->
							<div class="pos-abs pos-bottom-center">
								<div class="anim-fade tr-delay-03">
									<a href="project_drone.html" class="border-btn js-pointer-large js-animsition-link">
										<span class="border-btn__inner">Explore</span>
					...
					<div class="swiper-slide">
						...
						<div class="lines-container pos-rel no-lines d-flex flex-center-center height-100perc" data-swiper-parallax-y="60%">
							<!-- title start -->
							<h2 class="headline-xxxxl container small hidden-box">
								<a href="project_drone.html" class="anim-slide js-pointer-large js-animsition-link">Black Bike</a>
							</h2><!-- title end -->
							...
							<div class="flex-container portfolio-details">
								...
								<div class="four-columns column-50-100 padding-bottom-1 text-center">
									<span class="hidden-box d-inline-block">
										<span class="subhead-xxs anim-reveal tr-delay-02">Branding</span>
									</span>
								</div>
								<div class="four-columns column-50-100 padding-bottom-1 text-center">
									<span class="hidden-box d-inline-block">
										<span class="subhead-xxs anim-reveal tr-delay-04">Los Angeles 2019</span>
									</span>
								</div>
							</div><!-- portfolio-slider-details end -->
					...
					<div class="swiper-slide">
						...
						<div class="lines-container pos-rel no-lines d-flex flex-center-center height-100perc" data-swiper-parallax-y="60%">
							<!-- title start -->
							<h2 class="headline-xxxxl container small hidden-box">
								<a href="project_drone.html" class="anim-slide js-pointer-large js-animsition-link">Phone Case</a>
							</h2><!-- title end -->
							...
							<div class="flex-container portfolio-details">
								...
								<div class="four-columns column-50-100 padding-bottom-1 text-center">
									<span class="hidden-box d-inline-block">
										<span class="subhead-xxs anim-reveal tr-delay-04">Toronto 2020</span>
									</span>
								</div>
							</div><!-- portfolio-slider-details end -->
					...
					<div class="swiper-slide">
						...
						<div class="lines-container pos-rel no-lines d-flex flex-center-center height-100perc" data-swiper-parallax-y="60%">
							<!-- title start -->
							<h2 class="headline-xxxxl container small hidden-box">
								<a href="project_drone.html" class="anim-slide js-pointer-large js-animsition-link">Furniture</a>
							</h2><!-- title end -->
					...
					<div class="swiper-slide">
						...
						<div class="lines-container pos-rel no-lines d-flex flex-center-center height-100perc" data-swiper-parallax-y="60%">
							<!-- title start -->
							<h2 class="headline-xxxxl container small hidden-box">
								<a href="project_drone.html" class="anim-slide js-pointer-large js-animsition-link">Drone</a>
							</h2><!-- title end -->
							...
							<div class="flex-container portfolio-details">
								...
								<div class="four-columns column-50-100 padding-bottom-1 text-center">
									<span class="hidden-box d-inline-block">
										<span class="subhead-xxs anim-reveal tr-delay-04">London 2020</span>
									</span>
								</div>
							</div><!-- portfolio-slider-details end -->
					...
					<div class="swiper-slide">
						...
						<div class="lines-container pos-rel no-lines d-flex flex-center-center height-100perc" data-swiper-parallax-y="60%">
							<!-- title start -->
							<h2 class="headline-xxxxl container small hidden-box">
								<a href="project_drone.html" class="anim-slide js-pointer-large js-animsition-link">Pexels</a>
							</h2><!-- title end -->
							...
							<div class="flex-container portfolio-details">
								...
								<div class="four-columns column-50-100 padding-bottom-1 text-center">
									<span class="hidden-box d-inline-block">
										<span class="subhead-xxs anim-reveal tr-delay-04">Berlin 2020</span>
									</span>
								</div>
							</div><!-- portfolio-slider-details end -->
					...
					<div class="swiper-slide">
						...
						<div class="lines-container pos-rel no-lines d-flex flex-center-center height-100perc" data-swiper-parallax-y="60%">
							<!-- title start -->
							<h2 class="headline-xxxxl container small hidden-box">
								<a href="project_drone.html" class="anim-slide js-pointer-large js-animsition-link">Home Decor</a>
							</h2><!-- title end -->
							...
							<div class="flex-container portfolio-details">
								...
								<div class="four-columns column-50-100 padding-bottom-1 text-center">
									<span class="hidden-box d-inline-block">
										<span class="subhead-xxs anim-reveal tr-delay-04">Tokyo 2019</span>
									</span>
								</div>
							</div><!-- portfolio-slider-details end -->
					...
					<div class="swiper-slide">
						...
						<div class="lines-container pos-rel no-lines d-flex flex-center-center height-100perc" data-swiper-parallax-y="60%">
							<!-- title start -->
							<h2 class="headline-xxxxl container small small hidden-box">
								<a href="project_drone.html" class="anim-slide js-pointer-large js-animsition-link">Sneakers</a>
							</h2><!-- title end -->
							...
							<div class="flex-container portfolio-details">
								...
								<div class="four-columns column-50-100 padding-bottom-1 text-center">
									<span class="hidden-box d-inline-block">
										<span class="subhead-xxs anim-reveal tr-delay-04">Sydney 2020</span>
									</span>
								</div>
							</div><!-- portfolio-slider-details end -->
					...
					<div class="swiper-slide">
						...
						<div class="lines-container pos-rel no-lines d-flex flex-center-center height-100perc" data-swiper-parallax-y="60%">
							<!-- title start -->
							<h2 class="headline-xxxxl container small hidden-box">
								<a href="project_drone.html" class="anim-slide js-pointer-large js-animsition-link">Sandman</a>
							</h2><!-- title end -->
