...
<!-- End Google Tag Manager (noscript) -->
		...
		<main class="js-animsition-overlay" data-animsition-overlay="true">
			<!-- lines-section start -->
			<section id="up" class="lines-section pos-rel anim-lines js-parallax-bg" style="background-image:url(assets/images/posts/good-morning/beans-beverage-black-coffee-breakfast-373888.jpg)">
				<!-- bg-overlay -->
				<div class="bg-overlay-black"></div>
				<!-- lines-container start -->
				<div class="lines-container pos-rel anim-lines flex-min-height-100vh">
					<div class="padding-top-bottom-120 container small after-preloader-anim">
						...
						<div class="text-center">
							<h2 class="headline-xl anim-fade">Good morning! Have a nice day</h2>
						</div><!-- title end -->
						...
						<div class="flex-container description">
							<div class="four-columns column-50-100 padding-top-1 text-center">
								<span class="hidden-box d-inline-block">
									<span class="subhead-xxs anim-reveal">By: Jeffery Reder</span>
								</span>
							</div>
							<div class="four-columns column-50-100 padding-top-1 text-center">
								<span class="hidden-box d-inline-block">
				...
				<div class="lines-container pos-rel no-lines padding-top-bottom-120">
					...
					<article>
						<div class="container small">
							...
							<h3 class="headline-xxxs text-color-black padding-top-40">1. Scenester paleo knausgaard organic</h3>
							...
							<blockquote class="quote text-right">
								<p class="body-text-l text-color-black text-italic text-justify margin-top-20">Scenester semiotics plaid, vegan four loko vinyl twee bicycle rights letterpress you probably haven't heard of them before they sold out. Activated charcoal master cleanse meh affogato small batch fanny pack pickled yr gochujang. Fixie typewriter +1 roof party vexillologist. Locavore glossier fixie meggings af snackwave.</p>
								<cite class="d-block padding-top-10 subhead-xxs text-color-black">Michelle Stewart</cite>
							</blockquote>
							<h3 class="headline-xxxs text-color-black padding-top-40">2. Unicorn organic copper mug green juice</h3>
							...
							<h3 class="headline-xxxs text-color-black padding-top-40">3. Pour-over irure twee locavore gentrify ethical</h3>
							<p class="body-text-s text-color-black margin-top-20">Aesthetic scenester before they sold out deep v, vaporware etsy health goth cronut pork belly brunch franzen master cleanse keffiyeh kickstarter twee. Brunch trust fund tbh mustache quinoa retro raclette master cleanse plaid. Aliqua taxidermy polaroid gentrify vice whatever cardigan. Pour-over irure twee locavore gentrify ethical minim cornhole. Proident dolore bespoke stumptown fanny pack.</p>
						</div>
						<div class="padding-top-30">
							<div class="pos-rel">
								<img src="assets/images/posts/good-morning/coffee-magazine-6067.jpg" alt="Post">
								<!-- bg-overlay -->
								<div class="bg-overlay-black"></div>
						...
						<div class="container small">
							<h3 class="headline-xxxs text-color-black padding-top-40">4. Small batch stumptown direct trade single-origin</h3>
							...
							<h3 class="headline-xxxs text-color-black padding-top-40">5. Austin hammock cold-pressed brooklyn actually viral</h3>
							<p class="body-text-s text-color-black margin-top-20">Mollit voluptate +1, proident dolore artisan ad aute shabby chic. Shoreditch celiac adipisicing, consectetur fixie cray jean shorts aesthetic leggings keffiyeh raclette blue bottle lomo et reprehenderit. Austin hammock cold-pressed brooklyn actually viral ut nostrud locavore ramps. Velit non dolor, chartreuse beard messenger bag knausgaard affogato +1 copper mug aliqua sint. Etsy in prism iceland, ennui sint biodiesel tempor marfa dolore nostrud distillery palo santo. Scenester forage YOLO activated charcoal fashion axe meh. Paleo fugiat irure prism DIY keffiyeh pork belly.</p>
							<div class="padding-top-10">
								<div class="padding-top-20">
									<div class="anim-overlay js-scrollanim">
										<a href="assets/images/posts/good-morning/golden-cup-and-basket-with-books-6332.jpg" class="d-block js-photo-popup js-pointer-zoom">
											<img src="assets/images/posts/good-morning/golden-cup-and-basket-with-books-6332.jpg" alt="Post">
										</a>
									</div>
								</div>
								<div class="padding-top-20">
									<div class="anim-overlay js-scrollanim">
										<a href="assets/images/posts/good-morning/person-holding-white-ceramic-mug-with-black-liquid-272887.jpg" class="d-block js-photo-popup js-pointer-zoom">
											<img src="assets/images/posts/good-morning/person-holding-white-ceramic-mug-with-black-liquid-272887.jpg" alt="Post">
										</a>
									</div>
								</div>
								<div class="padding-top-20">
									<div class="anim-overlay js-scrollanim">
										<a href="assets/images/posts/good-morning/cafe-caffeine-cappuccino-close-up-437716.jpg" class="d-block js-photo-popup js-pointer-zoom">
											<img src="assets/images/posts/good-morning/cafe-caffeine-cappuccino-close-up-437716.jpg" alt="Post">
										</a>
									</div>
								</div>
							</div>
					...
					<div class="container small padding-top-90">
						<div class="flex-container padding-left-right-20 content-bg-light-2">
							<div class="three-columns padding-top-bottom-20">
								<div class="column-r-margin-20">
									<img src="assets/images/avatars/author/side-view-photography-of-a-woman-wearing-fedora-1070058.jpg" alt="Author">
								</div>
							</div>
							<div class="nine-columns padding-top-bottom-20">
								<h5 class="headline-xxxs text-color-black">Evelyn Ennis</h5>
								<p class="body-text-xs text-color-black margin-top-20">Truffaut forage pour-over la croix. Enamel pin wolf franzen lumbersexual sartorial marfa blue bottle man braid art party offal air plant umami health goth seitan. Health goth mustache pork belly celiac.</p>
								<ul class="list list_row list_right padding-top-20">
									<li class="list__item">
										<a href="#" class="icon-overlay-btn black js-pointer-large">
											<i class="icon-overlay-btn__inner fab fa-instagram"></i>
										</a>
			...
			<!-- next post start -->
			<section class="lines-section pos-rel bg-img-cover" style="background-image:url(assets/images/posts/red-cars/close-up-photo-of-car-rims-2811496.jpg)">
				<!-- bg-overlay -->
				<div class="bg-overlay-black"></div>
				<!-- lines-container start -->
				<div class="lines-container pos-rel flex-min-height-100vh">
					<div class="padding-top-bottom-120 container small text-center">
						<div class="js-scrollanim">
							<!-- button start -->
							<a href="post_red-cars.html" class="skew-btn js-pointer-large js-animsition-link anim-fade">
							...
							<div class="padding-top-30 text-center">
								<a href="post_red-cars.html" class="js-pointer-large js-animsition-link">
									<h2 class="headline-xl anim-fade tr-delay-02">Do red cars cost more to insure</h2>
								</a>
							</div><!-- title end -->
						</div>
					</div>
