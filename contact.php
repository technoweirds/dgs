...
<!-- End Google Tag Manager (noscript) -->
		...
		<main class="js-animsition-overlay" data-animsition-overlay="true">
			...
			<img src="assets\images\services\Conact Us Banners.jpg" alt="Italian Trulli">
					...
					<div class="padding-top-bottom-120 container">
						...
						<div class="padding-top-90">
							<ul class="list list_row list_margin-30px js-scrollanim">
								<li class="list__item ">
									<a href="https://www.facebook.com/DGeniussolutions/" class=" text-color-979797 js-pointer-small" data-text="Facebook">Facebook</a>
								</li>
								<li class="list__item anim-fade tr-delay-02">
									<a href="https://instagram.com/dgenius_solutions?utm_medium=copy_link" class=" text-color-979797 js-pointer-small" data-text="Instagram">Instagram</a>
								</li>
								<li class="list__item anim-fade tr-delay-03">
									<a href="https://www.linkedin.com/company/d-genius-solutions" class=" text-color-979797 js-pointer-small" data-text="Linkedin">Linkedin</a>
								</li>
                                                                <li class="list__item anim-fade tr-delay-03">
									<a href="https://twitter.com/DGenius_S?s=09" class=" text-color-979797 js-pointer-small" data-text="Twitter">Twitter</a>
								</li> 
							</ul>
						</div><!-- social btns end -->
					</div><!-- container end -->
			...
			<section class="pos-rel bg-img-cover" style="background-image:url(assets/images/backgrounds/architecture-buildings-city-fog-373965.jpg)">
				...
				<div class="pos-rel flex-min-height-100vh">
					...
					<div class="container small padding-top-bottom-120 form-box">
						...
						<!-- flex-container start -->
						<form action="contactbackend.php" method="post" name="formobrsv" id="send_form" class="flex-container padding-top-90 " onsubmit="return validateForm('email');">
							<!-- column start -->
