...
<html lang="en">
    ...
    <title>D'genius Solutions | Contact Us</title>
    <meta name="description" content="If you still feel doubtful about how to start marketing your business or build a social media channel or start a successfully running website- Contact Us!" />
...
<!-- End Google Tag Manager (noscript) -->
		...
		<main class="js-animsition-overlay" data-animsition-overlay="true">
			...
			<img src="assets/images/backgrounds/architecture-buildings-city-fog-373965.jpg" alt="Italian Trulli">
				...
				<div class="pos-rel flex-min-height-100vh">
					...
					<div class="padding-top-bottom-120 container">
						...
						<div class="js-scrollanim">
							<h1 class="headline-l">
								<span class="anim-slide" data-text="Contact">Contact Us</span>
								</h1>
							<p class="body-text-s margin-top-20 anim-slide">So, if you still feel doubtful about how to start marketing your business or build a social media channel or start a successfully running website our team would love to be at your service.</p>
						</div><!-- content end -->
							...
							<div class="four-columns column-50-100 padding-top-60">
								<div class="column-r-margin-20 js-scrollanim">
									...
									<h6 class="list list_margin-1px padding-top-20 text-color-b0b0b0">
										...
										<span class="list__item">
											<span class="d-inline-block hidden-box">
												<span class="text-color-dadada tr-delay-02">AI Ittihad Road, AI Nahda,</span>
											</span>
										</span>
										<span class="list__item">
											<span class="d-inline-block hidden-box">
												<span class="text-color-dadada tr-delay-03">32629 Sharjah, UAE.</span>
											</span>
										</span>
									</h6>
						...
						<div class="padding-top-90">
							<ul class="list list_row list_margin-30px js-scrollanim">
								...
								<li class="list__item anim-fade tr-delay-03">
									<a href="#" class="fill-btn text-color-979797 js-pointer-small" data-text="Linkedin">Linkedin</a>
								</li>
                                                                <li class="list__item anim-fade tr-delay-03">
