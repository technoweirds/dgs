  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Add/Edit User <i data-feather="plus"
      ...
      <form id="addform" method="POST" enctype="multipart/form-data">
        <div class="modal-body">
          <div class="form-group">
            ...
            <div class="input-group mb-3">
              <div class="input-group-prepend">
                <span class="input-group-text" id="basic-addon1"><i data-feather="user"
                    aria-hidden="true"></i>
              </div>
          ...
          <div class="form-group">
            ...
            <div class="input-group mb-3">
              <div class="input-group-prepend">
                <span class="input-group-text" id="basic-addon1"><i data-feather="message-square"
          ...
          <div class="form-group">
            ...
            <div class="input-group mb-3">
              <div class="input-group-prepend">
                <span class="input-group-text" id="basic-addon1"><i data-feather="phone-call"
                    aria-hidden="true"></i></span>
              </div>
          ...
          <!-- <div class="form-group">
            ...
            <div class="input-group mb-3">
              <div class="input-group-prepend">
                <span class="input-group-text" id="inputGroupFileAddon01"><i data-feather="image"
                    aria-hidden="true"></i></span>
              </div>
