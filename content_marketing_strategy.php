...
<html lang="en">
    ...
    <title>Content Marketing Strategy | D'genius Solutions</title>
    <meta name="description" content="We create content to show subject matter expertise in the business." />
				...
				<div class="lines-container pos-rel anim-lines flex-min-height-100vh">
					...
					<div class="padding-top-bottom-120 width-100perc">
						...
						<h1 class="headline-xxxl text-center after-preloader-anim">
							<span class="anim-text-fill" data-text="Content Marketing">Content Marketing</span><br>
							<span class="anim-text-fill tr-delay-01" data-text="Strategy">Strategy</span>
							</h1><!-- title end -->
					...
					<div class="four-columns column-100-100 padding-top-90">
						<div class="line-col-l-r-margin-20">
							...
							<h2 class="headline-s js-scrollanim">
								<span class="text-color-black" data-text="Content Marketing">Content Marketing</span><br>
								<span class="anim-text-fill tr-delay-01 text-color-black" data-text="Strategy">Strategy</span>
									</h2><!-- title end -->
                                                   	</div>
					</div><!-- column end -->
						...
						<div class="padding-top-90 grid-item-50-50-100 js-isotope-grid-item">
							...
							<div class="grid-margin-box text-right js-scrollanim">
								<div class="anim-fade">
									...
									<h3 class="headline-xxs text-color-black margin-top-30">Content Creation & Curation</h3>
									<p class="body-text-xs text-color-black margin-top-20">We create content to show our subject matter expertise in the business. Promoting a brand USP through content creation draws quick limelight in the world of social media.  This created content is then used to curate it with the current trends of the world not letting go of the limelight once captured.</p>
								</div>
						...
						<div class="padding-top-90 grid-item-50-50-100 js-isotope-grid-item">
							...
							<div class="grid-margin-box js-scrollanim">
								<div class="anim-fade">
									...
									<h3 class="headline-xxs text-color-black margin-top-30">Copywriting</h3>
									<p class="body-text-xs text-color-black margin-top-20">Our expert content team knows how to use just about the right language to create a deeper connection with your audience.</p>
								</div>
							</div><!-- grid-margin-box end -->
						</div><!-- grid-item end -->
                                                  <!-- grid-item start -->
						<div class="padding-top-90 grid-item-50-50-100 js-isotope-grid-item">
							...
							<div class="grid-margin-box text-right js-scrollanim">
								<div class="anim-fade">
									...
									<h3 class="headline-xxs text-color-black margin-top-30">Content Editing</h3>
									<p class="body-text-xs text-color-black margin-top-20">We know how to professionally edit and customize your data and your brand language in order to optimize it with visual designs and comprehensibility.</p>
							</div>
							</div><!-- grid-margin-box end -->
						</div><!-- grid-item end -->
