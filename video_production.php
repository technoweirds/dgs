...
<html lang="en">
    ...
    <title>Video Production | D'genius Solutions</title>
    <meta name="description" content="We create video collaterals, film branding, Social media platform ads, TV commercials and much more." />
				...
				<div class="lines-container pos-rel anim-lines flex-min-height-100vh">
					...
					<div class="padding-top-bottom-120 width-100perc">
						...
						<h1 class="headline-xxxl text-center after-preloader-anim">
							<span class="anim-text-fill" data-text="Video">Video</span><br>
							<span class="anim-text-fill tr-delay-01" data-text=" Production"> Production</span>
							</h1><!-- title end -->
					...
					<div class="four-columns column-100-100 padding-top-90">
						<div class="line-col-l-r-margin-20">
							...
							<h2 class="headline-s js-scrollanim js-scrollanim-active">
								<span class="text-color-black">Video</span>
								<br>
								<span class="text-color-black tr-delay-01">Production</span>
								</h2><!-- title end -->
							<p class="body-text-s text-color-black margin-top-20 anim-text-reveal tr-delay-08 js-scrollanim"></p>
							</div>
					</div><!-- column end -->
						...
						<div class="padding-top-90 grid-item-50-50-100 js-isotope-grid-item">
							...
							<div class="grid-margin-box js-scrollanim">
								<div class="anim-fade">
									...
									<h3 class="headline-xxs text-color-black margin-top-30">Pre-Production</h3>
									<ul class="list text-color-dadada margin-top-30 js-scrollanim js-scrollanim-active">
									<li class="list__item red dot hidden-box">
										<div class="subhead-xxs anim-slide ">Video Strategy/Goals</div>
									</li>
									<li class="list__item red dot hidden-box">
										<div class="subhead-xxs anim-slide tr-delay-01">Budget/Scope</div>
									</li>
									<li class="list__item red dot hidden-box">
										<div class="subhead-xxs anim-slide tr-delay-02">Story Selection</div>
									</li>
									<li class="list__item red dot hidden-box">
										<div class="subhead-xxs anim-slide tr-delay-03">Project Timeline</div>
									</li>
									<li class="list__item red dot hidden-box">
										<div class="subhead-xxs anim-slide tr-delay-04">Script Creation</div>
									</li>
									<li class="list__item red dot hidden-box">
										<div class="subhead-xxs anim-slide tr-delay-05">Talent/Characters</div>
									</li>
									<li class="list__item red dot hidden-box">
										<div class="subhead-xxs anim-slide tr-delay-06">Production Team</div>
									</li>
                                                                        <li class="list__item red dot hidden-box">
										<div class="subhead-xxs anim-slide tr-delay-06">Equipment Needs</div>
									</li>
                                                                        <li class="list__item red dot hidden-box">
										<div class="subhead-xxs anim-slide tr-delay-06">Location Scouting</div>
									</li>
								</ul>   								
                                                                  </div>
						...
						<div class="padding-top-90 grid-item-50-50-100 js-isotope-grid-item">
							...
							<div class="grid-margin-box js-scrollanim">
								<div class="anim-fade">
									...
									<h3 class="headline-xxs text-color-black margin-top-30">Production</h3>
									<ul class="list text-color-dadada margin-top-30 js-scrollanim js-scrollanim-active">
									<li class="list__item red dot hidden-box">
										<div class="subhead-xxs anim-slide ">Setting Up the Sound</div>
									</li>
									<li class="list__item red dot hidden-box">
										<div class="subhead-xxs anim-slide tr-delay-01">Lighting</div>
									</li>
									<li class="list__item red dot hidden-box">
										<div class="subhead-xxs anim-slide tr-delay-02">Video Equipment</div>
									</li>
									<li class="list__item red dot hidden-box">
										<div class="subhead-xxs anim-slide tr-delay-03">Conducting Interviews</div>
									</li>
									<li class="list__item red dot hidden-box">
										<div class="subhead-xxs anim-slide tr-delay-04">Recording Voiceovers</div>
									</li>
									<li class="list__item red dot hidden-box">
										<div class="subhead-xxs anim-slide tr-delay-05">Capturing b-roll</div>
									</li>
									<ul> 
								</div>
							</div><!-- grid-margin-box end -->
						...
						<div class="padding-top-90 grid-item-50-50-100 js-isotope-grid-item">
							...
							<div class="grid-margin-box js-scrollanim">
								<div class="anim-fade">
									...
									<h3 class="headline-xxs text-color-black margin-top-30">Post-Production</h3>
									
									<ul class="list text-color-dadada margin-top-30 js-scrollanim js-scrollanim-active">
									<li class="list__item red dot hidden-box">
										<div class="subhead-xxs anim-slide ">Logging the Interviews</div>
									</li>
									<li class="list__item red dot hidden-box">
										<div class="subhead-xxs anim-slide tr-delay-01">Producing the Final Story</div>
									</li>
									<li class="list__item red dot hidden-box">
										<div class="subhead-xxs anim-slide tr-delay-02">Music Selection Video Editing</div>
									</li>
									<li class="list__item red dot hidden-box">
										<div class="subhead-xxs anim-slide tr-delay-03">Reviews/Approvals</div>
									</li>
									</ul> 
								</div>
							</div><!-- grid-margin-box end -->
