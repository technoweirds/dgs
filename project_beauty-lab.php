...
<!-- End Google Tag Manager (noscript) -->
		...
		<main class="js-animsition-overlay" data-animsition-overlay="true">
			<!-- pos-rel start -->
			<section id="up" class="pos-rel bg-img-cover" style="background-image:url(assets/images/projects/beauty-lab/beauty-beauty-product-cosmetics-makeup-2845213.jpg)">
				<!-- bg-overlay -->
				<div class="bg-overlay-black"></div>
				<!-- pos-rel start -->
				<div class="pos-rel flex-min-height-100vh">
					<div class="padding-top-bottom-120 width-100perc after-preloader-anim">
						...
						<h2 class="headline-xxxxl text-center hidden-box">
							<span class="anim-slide">Beauty Lab</span>
						</h2><!-- title end -->
						...
						<div class="flex-container description">
							<div class="four-columns column-50-100 padding-top-1 text-center">
								<span class="hidden-box d-inline-block">
									<span class="subhead-xxs anim-reveal">Branding</span>
								</span>
							</div>
							<div class="four-columns column-50-100 padding-top-1 text-center">
								<span class="hidden-box d-inline-block">
									<span class="subhead-xxs anim-reveal tr-delay-02">Ui/UX design</span>
								</span>
							</div>
							<div class="four-columns column-50-100 padding-top-1 text-center">
								<span class="hidden-box d-inline-block">
									<span class="subhead-xxs anim-reveal tr-delay-04">Melbourne 2019</span>
								</span>
							</div>
						</div><!-- description end -->
					</div>
			...
			<!-- bg-img-cover start -->
			<div class="pos-rel height-100vh bg-img-cover" style="background-image:url(assets/images/projects/beauty-lab/flowers-orchid-minimalism-orchids-2845216.jpg)">
				<!-- bg-overlay -->
				<div class="bg-overlay-black"></div>
					...
					<div class="container padding-top-100 padding-bottom-120">
						...
						<div class="flex-container">
							...
							<div class="four-columns column-100-100 padding-top-20">
								<h2 class="headline-xxs js-scrollanim">
									<span class="hidden-box d-block">
										<span class="anim-slide">IPhone humblebrag</span>
									</span>
									<span class="hidden-box d-block">
										<span class="anim-slide tr-delay-01">kale chips</span>
									</span>
								</h2>
							</div><!-- column end -->
							...
							<div class="eight-columns column-100-100 padding-top-20">
								<div class="column-l-margin-40-999">
									<p class="body-text-m anim-text-reveal js-scrollanim">Brooklyn whatever chia deep v slow-carb lomo put a bird on. Austin fam chia cold-pressed raw denim. Retro jean shorts cronut lumbersexual mixtape hella you probably haven't heard of them austin williamsburg af mustache pinterest. Mixtape kinfolk cray, wolf palo santo brunch iPhone. 3 wolf moon microdosing scenester, tilde roof party affogato typewriter celiac echo park craft beer bicycle rights man braid trust fund four dollar toast gentrify. IPhone humblebrag kale chips hell of.</p>
								</div>
							</div><!-- column end -->
						</div><!-- flex-container end -->

						<div class="padding-top-120">
							<a href="assets/images/projects/beauty-lab/cosmetic-creams-on-a-magazine-2834934.jpg" class="d-block js-pointer-zoom js-photo-popup">
								<img src="assets/images/projects/beauty-lab/cosmetic-creams-on-a-magazine-2834934.jpg" alt="project image">
							</a>
						</div>
						<div class="padding-top-120">
							<a href="assets/images/projects/beauty-lab/pexels-3165053.jpg" class="d-block js-pointer-zoom js-photo-popup">
								<img src="assets/images/projects/beauty-lab/pexels-3165053.jpg" alt="project image">
							</a>
						</div>
					</div><!-- container end -->
				</div><!-- pos-rel end -->
			...
			<!-- bg-img-cover start -->
			<div class="pos-rel height-100vh bg-img-cover" style="background-image:url(assets/images/projects/beauty-lab/gold-iphone-8-2872404.jpg)">
				<!-- bg-overlay -->
				<div class="bg-overlay-black"></div>
			</div><!-- bg-img-cover end -->

			<!-- pos-rel start -->
			<div class="pos-rel section-bg-light-1" data-midnight="black">
				<!-- pos-rel start -->
				<div class="pos-rel">
					<div class="container padding-bottom-120">
						<div class="padding-top-120">
							<a href="assets/images/projects/beauty-lab/book-feathers-accessories-earrings-3248661.jpg" class="d-block js-pointer-zoom js-photo-popup">
								<img src="assets/images/projects/beauty-lab/book-feathers-accessories-earrings-3248661.jpg" alt="project image">
							</a>
						</div>
						<div class="padding-top-120">
							<a href="assets/images/projects/beauty-lab/rose-gold-iphone-7-plus-beside-pencils-on-book-2897035.jpg" class="d-block js-pointer-zoom js-photo-popup">
								<img src="assets/images/projects/beauty-lab/rose-gold-iphone-7-plus-beside-pencils-on-book-2897035.jpg" alt="project image">
							</a>
						</div>
						<div class="padding-top-120">
							<a href="assets/images/projects/beauty-lab/candle-beauty-rose-pretty-3042823.jpg" class="d-block js-pointer-zoom js-photo-popup">
								<img src="assets/images/projects/beauty-lab/candle-beauty-rose-pretty-3042823.jpg" alt="project image">
							</a>
						</div>
						<div class="padding-top-120">
							<a href="assets/images/projects/beauty-lab/kinfolk-tag-on-blanket-2870724.jpg" class="d-block js-pointer-zoom js-photo-popup">
								<img src="assets/images/projects/beauty-lab/kinfolk-tag-on-blanket-2870724.jpg" alt="project image">
							</a>
						</div>
					</div>
				</div><!-- pos-rel end -->
				...
				<div class="pos-rel flex-min-height-100vh">
					...
					<div class="container flex-container padding-top-100 padding-bottom-120">
						...
						<div class="four-columns column-100-100 padding-top-20">
							<h2 class="headline-xxs js-scrollanim">
								<span class="hidden-box d-block">
									<span class="anim-slide">Retro jean shorts</span>
								</span>
								<span class="hidden-box d-block">
									<span class="anim-slide tr-delay-01">cronut lumbersexual</span>
								</span>
							</h2>
						</div><!-- column end -->
			...
			<!-- bg-img-cover start -->
			<div class="pos-rel height-100vh bg-img-cover" style="background-image:url(assets/images/projects/beauty-lab/pexels-3190317.jpg)">
				<!-- bg-overlay -->
				<div class="bg-overlay-black"></div>
			</div><!-- bg-img-cover end -->
					...
					<div class="width-100perc padding-top-100 padding-bottom-120">
						...
						<div class="flex-container container">
							...
							<div class="four-columns column-100-100 padding-top-20">
								<h2 class="headline-xxs js-scrollanim">
									<span class="hidden-box d-block">
										<span class="anim-slide">Trust fund four</span>
									</span>
									<span class="hidden-box d-block">
										<span class="anim-slide tr-delay-01">dollar toast gentrify</span>
									</span>
								</h2>
							</div><!-- column end -->
						...
						<div class="js-2-view-slider padding-top-120 padding-bottom-90 hidden-box pos-rel">
							<!-- swiper-wrapper start -->
							<div class="swiper-wrapper js-slider-scroll-anim">
								...
								<div class="swiper-slide">
									...
									<div class="anim-img-scale">
										<img class="anim-img-scale__inner" src="assets/images/projects/beauty-lab/women-in-this-town-magazine-2962806.jpg" alt="project image">
								...
								<div class="swiper-slide">
									<!-- anim-img-scale start -->
									<div class="anim-img-scale">
										<img class="anim-img-scale__inner" src="assets/images/projects/beauty-lab/daily-care-routine-3321416.jpg" alt="project image">
									</div><!-- anim-img-scale end -->
								</div><!-- swiper-slide end -->
								<!-- swiper-slide start -->
								<div class="swiper-slide">
									<!-- anim-img-scale start -->
									<div class="anim-img-scale">
										<img class="anim-img-scale__inner" src="assets/images/projects/beauty-lab/candke-2910959.jpg" alt="project image">
									</div><!-- anim-img-scale end -->
								</div><!-- swiper-slide end -->
								<!-- swiper-slide start -->
								<div class="swiper-slide">
									<!-- anim-img-scale start -->
									<div class="anim-img-scale">
										<img class="anim-img-scale__inner" src="assets/images/projects/beauty-lab/makeup-set-with-tray-beside-wall-2866796.jpg" alt="project image">
									</div><!-- anim-img-scale end -->
								</div><!-- swiper-slide end -->
								<!-- swiper-slide start -->
								<div class="swiper-slide">
									<!-- anim-img-scale start -->
									<div class="anim-img-scale">
										<img class="anim-img-scale__inner" src="assets/images/projects/beauty-lab/pair-of-earrings-on-tray-2872405.jpg" alt="project image">
									</div><!-- anim-img-scale end -->
								</div><!-- swiper-slide end -->
							</div><!-- swiper-wrapper end -->
				...
				<div class="pos-rel flex-min-height-100vh">
					<div class="container small padding-top-bottom-120">
						<div class="js-scrollanim">
							<blockquote class="quote body-text-l anim-text-reveal">"Synth keytar distillery offal man braid sartorial 90's blue bottle fanny pack kale chips craft beer pok pok chambray. Yuccie listicle bicycle rights put a bird on it lyft flexitarian direct trade meggings vape chicharrones green juice man bun. Organic craft beer chambray, migas vinyl chartreuse godard palo santo lomo readymade vexillologist. DIY occupy craft beer 3 wolf moon, VHS cornhole master cleanse irony paleo vaporware butcher chicharrones."</blockquote>
							<h5 class="margin-top-20 text-right">
								<span class="subhead-s anim-text-double-fill tr-delay-01" data-text="Jason Hardeman">Jason Hardeman</span><br>
								<span class="headline-xxxxs margin-top-5 anim-text-double-fill invert tr-delay-03" data-text="XOXO production LTD">XOXO production LTD</span>
							</h5>
						</div>
					</div>
				</div><!-- pos-rel end -->
			...
			<!-- next project start -->
			<section class="pos-rel bg-img-cover" style="background-image:url(assets/images/projects/blue-ridge/flat-lay-photography-of-several-product-bottles-on-withered-1667071.jpg)">
				<!-- bg-overlay -->
				<div class="bg-overlay-black"></div>
				<!-- pos-rel start -->
				<div class="pos-rel flex-min-height-100vh">
					<div class="padding-top-bottom-120 width-100perc text-center">
						<div class="js-scrollanim">
							...
							<div class="margin-top-10 margin-bottom-30">
								<a href="project_blue-ridge.html" class="d-block hidden-box js-pointer-large js-animsition-link">
									<h2 class="headline-xxxxl anim-slide">Blue Ridge</h2>
								</a>
							</div><!-- title end -->

							<!-- button start -->
							<a href="project_blue-ridge.html" class="skew-btn js-pointer-large js-animsition-link anim-fade tr-delay-04">
