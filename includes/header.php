...
s1.async=true;
s1.src='https://embed.tawk.to/60db5fb065b7290ac6388e58/1f9cerjds';
s1.charset='UTF-8';
			...
			<div class="pos-rel height-100perc">
				...
				<ul class="menu-box">
					...
					<li class="nav-btn-box js-dropdown-slider-open">
						<a href="services.php" class="nav-btn large dropdown-hidden-btn js-animsition-link js-pointer-large">
