...
<!-- End Google Tag Manager (noscript) -->
		...
		<main class="js-animsition-overlay" data-animsition-overlay="true">
			<!-- lines-section start -->
			<section id="up" class="lines-section pos-rel anim-lines bg-img-cover" style="background-image:url(assets/images/projects/blue-ridge/flat-lay-photography-of-several-product-bottles-on-withered-1667071.jpg)">
				<!-- bg-overlay -->
				<div class="bg-overlay-black"></div>
				<!-- lines-container start -->
				<div class="lines-container pos-rel anim-lines flex-min-height-100vh">
					<div class="padding-top-bottom-120 width-100perc after-preloader-anim">
						...
						<h2 class="headline-xxxxl text-center hidden-box">
							<span class="anim-slide">Blue Ridge</span>
						</h2><!-- title end -->
						...
						<div class="flex-container description">
							...
							<div class="four-columns column-50-100 padding-top-1 text-center">
								<span class="hidden-box d-inline-block">
									<span class="subhead-xxs anim-reveal tr-delay-04">New York 2018</span>
								</span>
							</div>
						</div><!-- description end -->
					</div>
					...
					<div class="container flex-container padding-top-60 padding-bottom-120">
						...
						<div class="eight-columns column-100-100 padding-top-60">
							<div class="column-r-margin-40-999 js-scrollanim">
								...
								<div class="margin-top-30 anim-fade tr-delay-04">
						...
						<div class="four-columns column-100-100 padding-top-60">
							<div class="js-scrollanim">
								<h4 class="headline-xxs hidden-box">
									<span class="anim-slide">Services</span>
								</h4>
								<!-- list start -->
								<ul class="list text-color-dadada margin-top-20">
									<li class="list__item red dot hidden-box">
										<p class="subhead-xxs anim-slide tr-delay-01">Graphic Design</p>
									</li>
									<li class="list__item red dot hidden-box">
										<p class="subhead-xxs anim-slide tr-delay-02">User Interface Design</p>
									</li>
									<li class="list__item red dot hidden-box">
										<p class="subhead-xxs anim-slide tr-delay-03">User Experience Design</p>
									</li>
									<li class="list__item red dot hidden-box">
										<p class="subhead-xxs anim-slide tr-delay-04">Web Design</p>
									</li>
									<li class="list__item red dot hidden-box">
										<p class="subhead-xxs anim-slide tr-delay-05">Motion Design</p>
									</li>
									<li class="list__item red dot hidden-box">
										<p class="subhead-xxs anim-slide tr-delay-06">Front-end Development</p>
									</li>
									<li class="list__item red dot hidden-box">
										<p class="subhead-xxs anim-slide tr-delay-07">Back-end Development</p>
									</li>
								</ul><!-- list end -->
							</div>
						</div><!-- column end -->
			...
			<!-- lines-section start -->
			<div class="lines-section pos-rel section-bg-dark-1">
				<!-- lines-container start -->
				<div class="lines-container pos-rel no-lines padding-top-60 padding-bottom-120">
					<!-- flex-container start -->
					<div class="flex-container margin-left-right-20">
						<!-- column start -->
						<div class="six-columns padding-top-60">
							<a href="assets/images/projects/blue-ridge/black-jeans-1667081.jpg" class="column-l-r-margin-20 d-block js-pointer-zoom js-photo-popup">
								<img src="assets/images/projects/blue-ridge/black-jeans-1667081.jpg" alt="project image">
							</a>
						</div><!-- column end -->

						<!-- column start -->
						<div class="six-columns padding-top-60">
							<a href="assets/images/projects/blue-ridge/blue-ridge-hemp-cbd-cbd-for-headache-cbd-life-1667070.jpg" class="column-l-r-margin-20 d-block js-pointer-zoom js-photo-popup">
								<img src="assets/images/projects/blue-ridge/blue-ridge-hemp-cbd-cbd-for-headache-cbd-life-1667070.jpg" alt="project image">
							</a>
						</div><!-- column end -->

						<!-- column start -->
						<div class="twelve-columns padding-top-60">
							<a href="assets/images/projects/blue-ridge/blue-ridge-hemp-cbd-cbd-for-headache-cbd-life-1667067.jpg" class="column-l-r-margin-20 d-block js-pointer-zoom js-photo-popup">
								<img src="assets/images/projects/blue-ridge/blue-ridge-hemp-cbd-cbd-for-headache-cbd-life-1667067.jpg" alt="project image">
							</a>
						</div><!-- column end -->
					</div><!-- flex-container end -->
				</div><!-- lines-container end -->
			</div><!-- lines-section end -->
			...
			<section class="lines-section pos-rel black-lines section-bg-light-1" data-midnight="black">
				...
				<div class="lines-container pos-rel no-lines flex-min-height-100vh">
					...
					<div class="container flex-container padding-top-60 padding-bottom-120">
						...
						<div class="eight-columns column-100-100 padding-top-60">
							<div class="column-r-margin-40-999 js-scrollanim">
								<h2 class="headline-xxs text-color-black hidden-box">
									<span class="anim-slide">Brooklyn whatever chia deep</span>
								</h2>
								<p class="body-text-m text-color-black margin-top-20 anim-text-reveal tr-delay-02">3 wolf moon microdosing scenester, tilde roof party affogato typewriter celiac echo park craft beer bicycle rights man braid trust fund four dollar toast gentrify. IPhone humblebrag kale chips hell of. Brooklyn whatever chia deep v slow-carb lomo put a bird on. Retro jean shorts cronut lumbersexual mixtape hella you probably haven't heard of them austin williamsburg af mustache pinterest. Mixtape kinfolk cray, wolf palo santo brunch iPhone.</p>
							</div>
						</div><!-- column end -->
						...
						<div class="four-columns column-100-100 padding-top-60">
							<!-- list start -->
							<ul class="list list_counter text-color-888888 js-scrollanim">
								<li class="list__item black opacity-05 hidden-box">
									<p class="subhead-xxs anim-slide">Mlkshk YOLO</p>
								</li>
								<li class="list__item black opacity-05 hidden-box">
									<p class="subhead-xxs anim-slide tr-delay-01">Leggings vinyl</p>
								</li>
								<li class="list__item black opacity-05 hidden-box">
									<p class="subhead-xxs anim-slide tr-delay-02">Crucifix stumptown</p>
								</li>
								<li class="list__item black opacity-05 hidden-box">
									<p class="subhead-xxs anim-slide tr-delay-03">Pabst venmo gentrify</p>
								</li>
								<li class="list__item black opacity-05 hidden-box">
									<p class="subhead-xxs anim-slide tr-delay-04">Deep v microdosing</p>
								</li>
								<li class="list__item black opacity-05 hidden-box">
									<p class="subhead-xxs anim-slide tr-delay-05">Migas occupy master</p>
								</li>
								<li class="list__item black opacity-05 hidden-box">
									<p class="subhead-xxs anim-slide tr-delay-06">Cleanse intelligentsia</p>
								</li>
							</ul><!-- list end -->
						</div><!-- column end -->
					</div><!-- flex-container end -->
			...
			<!-- lines-section start -->
			<div class="lines-section pos-rel black-lines section-bg-light-1" data-midnight="black">
				<!-- lines-container start -->
				<div class="lines-container pos-rel no-lines padding-top-60 padding-bottom-120">
					<!-- flex-container start -->
					<div class="flex-container margin-left-right-20">
						<!-- column start -->
						<div class="twelve-columns padding-top-60">
							<a href="assets/images/projects/blue-ridge/blue-ridge-hemp-cbd-cbd-for-headache-cbd-life-1667076.jpg" class="column-l-r-margin-20 d-block js-pointer-zoom js-photo-popup">
								<img src="assets/images/projects/blue-ridge/blue-ridge-hemp-cbd-cbd-for-headache-cbd-life-1667076.jpg" alt="project image">
							</a>
						</div><!-- column end -->

						<!-- column start -->
						<div class="six-columns padding-top-60">
							<a href="assets/images/projects/blue-ridge/blue-ridge-hemp-cbd-cbd-life-hemp-1667082.jpg" class="column-l-r-margin-20 d-block js-pointer-zoom js-photo-popup">
								<img src="assets/images/projects/blue-ridge/blue-ridge-hemp-cbd-cbd-life-hemp-1667082.jpg" alt="project image">
							</a>
						</div><!-- column end -->

						<!-- column start -->
						<div class="six-columns padding-top-60">
							<a href="assets/images/projects/blue-ridge/blue-ridge-hemp-cbd-cbd-life-hemp-1667083.jpg" class="column-l-r-margin-20 d-block js-pointer-zoom js-photo-popup">
								<img src="assets/images/projects/blue-ridge/blue-ridge-hemp-cbd-cbd-life-hemp-1667083.jpg" alt="project image">
							</a>
						</div><!-- column end -->

						<!-- column start -->
						<div class="six-columns padding-top-60">
							<a href="assets/images/projects/blue-ridge/blue-ridge-hemp-cbd-cbd-life-hemp-1667087.jpg" class="column-l-r-margin-20 d-block js-pointer-zoom js-photo-popup">
								<img src="assets/images/projects/blue-ridge/blue-ridge-hemp-cbd-cbd-life-hemp-1667087.jpg" alt="project image">
							</a>
						</div><!-- column end -->

						<!-- column start -->
						<div class="six-columns padding-top-60">
							<a href="assets/images/projects/blue-ridge/blue-ridge-hemp-cbd-cbd-life-hemp-1667090.jpg" class="column-l-r-margin-20 d-block js-pointer-zoom js-photo-popup">
								<img src="assets/images/projects/blue-ridge/blue-ridge-hemp-cbd-cbd-life-hemp-1667090.jpg" alt="project image">
							</a>
						</div><!-- column end -->

						<!-- column start -->
						<div class="twelve-columns padding-top-60">
							<a href="assets/images/projects/blue-ridge/brown-and-black-plastic-container-1667088.jpg" class="column-l-r-margin-20 d-block js-pointer-zoom js-photo-popup">
								<img src="assets/images/projects/blue-ridge/brown-and-black-plastic-container-1667088.jpg" alt="project image">
							</a>
						</div><!-- column end -->
					</div><!-- flex-container end -->
				</div><!-- lines-container end -->
				...
				<div class="lines-container pos-rel no-lines flex-min-height-100vh">
					...
					<div class="container small padding-top-60 padding-bottom-120">
						<div class="padding-top-60">
							<div class="js-scrollanim">
								<h2 class="headline-xxs hidden-box">
									<span class="anim-slide">Chillwave cronut messenger</span>
								</h2>
								<p class="body-text-s margin-top-20 anim-text-reveal tr-delay-02">IPhone humblebrag kale chips hell of. Brooklyn whatever chia deep v slow-carb lomo put a bird on. Mlkshk YOLO wolf, leggings vinyl crucifix stumptown tousled. Pabst venmo gentrify deep v microdosing migas occupy master cleanse intelligentsia sartorial chia activated charcoal. Iceland small batch live-edge raclette roof party dreamcatcher austin pickled. Chillwave cronut messenger bag truffaut. 3 wolf moon microdosing scenester, tilde roof party affogato typewriter celiac echo park craft beer bicycle rights man braid trust fund four dollar toast gentrify.</p>
							</div>
						</div>
						<div class="padding-top-60">
							<div class="js-scrollanim">
								<h2 class="headline-xxs hidden-box">
									<span class="anim-slide">Mixtape kinfolk cray</span>
								</h2>
			...
			<div class="lines-section pos-rel section-bg-dark-1">
				...
				<div class="lines-container pos-rel no-lines padding-top-60 padding-bottom-120">
					...
					<div class="flex-container margin-left-right-20">
						<!-- column start -->
						<div class="twelve-columns padding-top-60">
							<a href="assets/images/projects/blue-ridge/blue-ridge-hemp-cbd-cbd-for-headache-cbd-life-1667074.jpg" class="column-l-r-margin-20 d-block js-pointer-zoom js-photo-popup">
								<img src="assets/images/projects/blue-ridge/blue-ridge-hemp-cbd-cbd-for-headache-cbd-life-1667074.jpg" alt="project image">
							</a>
						</div><!-- column end -->

						<!-- column start -->
						<div class="six-columns padding-top-60">
							<a href="assets/images/projects/blue-ridge/blue-ridge-hemp-cbd-cbd-for-headache-cbd-life-1667073.jpg" class="column-l-r-margin-20 d-block js-pointer-zoom js-photo-popup">
								<img src="assets/images/projects/blue-ridge/blue-ridge-hemp-cbd-cbd-for-headache-cbd-life-1667073.jpg" alt="project image">
							</a>
						</div><!-- column end -->

						<!-- column start -->
						<div class="six-columns padding-top-60">
							<a href="assets/images/projects/blue-ridge/man-wearing-gray-bottoms-1667080.jpg" class="column-l-r-margin-20 d-block js-pointer-zoom js-photo-popup">
								<img src="assets/images/projects/blue-ridge/man-wearing-gray-bottoms-1667080.jpg" alt="project image">
							</a>
						</div><!-- column end -->

						<!-- column start -->
						<div class="twelve-columns padding-top-60">
							<a href="assets/images/projects/blue-ridge/blue-ridge-hemp-cbd-cbd-for-headache-cbd-life-1667075.jpg" class="column-l-r-margin-20 d-block js-pointer-zoom js-photo-popup">
								<img src="assets/images/projects/blue-ridge/blue-ridge-hemp-cbd-cbd-for-headache-cbd-life-1667075.jpg" alt="project image">
							</a>
						</div><!-- column end -->
					</div><!-- flex-container end -->
				</div><!-- lines-container end -->
				...
				<div class="lines-container pos-rel no-lines flex-min-height-100vh">
					...
					<div class="width-100perc padding-top-60 padding-bottom-120">
						...
						<div class="flex-container margin-left-right-20">
							<!-- column start -->
							<div class="six-columns padding-top-60">
								<a href="assets/images/projects/blue-ridge/blue-ridge-hemp-cbd-cbd-life-hemp-1667084.jpg" class="column-l-r-margin-20 d-block js-pointer-zoom js-photo-popup">
									<img src="assets/images/projects/blue-ridge/blue-ridge-hemp-cbd-cbd-life-hemp-1667084.jpg" alt="project image">
								</a>
							</div><!-- column end -->

							<!-- column start -->
							<div class="six-columns padding-top-60">
								<a href="assets/images/projects/blue-ridge/depth-of-field-photography-of-person-wearing-brown-plaid-1667079.jpg" class="column-l-r-margin-20 d-block js-pointer-zoom js-photo-popup">
									<img src="assets/images/projects/blue-ridge/depth-of-field-photography-of-person-wearing-brown-plaid-1667079.jpg" alt="project image">
								</a>
							</div><!-- column end -->
						</div><!-- flex-container end -->
						...
						<div class="container small padding-top-120">
							<div class="js-scrollanim">
								<h2 class="headline-xxs text-color-black hidden-box">
									<span class="anim-slide">Pabst venmo gentrify deep</span>
								</h2>
								<p class="body-text-s text-color-black margin-top-20 anim-text-reveal tr-delay-02">Iceland small batch live-edge raclette roof party dreamcatcher austin pickled. IPhone humblebrag kale chips hell of. Brooklyn whatever chia deep v slow-carb lomo put a bird on. Mlkshk YOLO wolf, leggings vinyl crucifix stumptown tousled. Pabst venmo gentrify deep v microdosing migas occupy master cleanse intelligentsia sartorial chia activated charcoal. Chillwave cronut messenger bag truffaut. 3 wolf moon microdosing scenester, tilde roof party affogato typewriter celiac echo park craft beer bicycle rights man braid trust fund four dollar toast gentrify.</p>
							</div>
						</div><!-- container end -->
			...
			<div class="lines-section pos-rel section-bg-dark-1">
				...
				<div class="lines-container pos-rel no-lines flex-min-height-100vh">
					<div class="container small padding-top-bottom-120">
						<blockquote class="quote body-text-l anim-text-reveal js-scrollanim">"Synth keytar distillery offal man braid sartorial 90's blue bottle fanny pack kale chips craft beer pok pok chambray. Yuccie listicle bicycle rights put a bird on it lyft flexitarian direct trade meggings vape chicharrones green juice man bun. Organic craft beer chambray, migas vinyl chartreuse godard palo santo lomo readymade vexillologist. DIY occupy craft beer 3 wolf moon, VHS cornhole master cleanse irony paleo vaporware butcher chicharrones."</blockquote>
					</div>
				</div><!-- lines-container end -->
			</div><!-- lines-section end -->

			<!-- next project start -->
			<section class="lines-section pos-rel bg-img-cover" style="background-image:url(assets/images/projects/drone/quadcopter-on-wooden-surface-1601217.jpg)">
				<!-- bg-overlay -->
				<div class="bg-overlay-black"></div>
				<!-- lines-container start -->
					...
					<div class="padding-top-bottom-120 width-100perc text-center">
						<div class="js-scrollanim">
							...
							<div class="margin-top-10 margin-bottom-30">
								<a href="project_drone.html" class="d-block hidden-box js-pointer-large js-animsition-link">
									<h2 class="headline-xxxxl anim-slide">Drone</h2>
								</a>
							</div><!-- title end -->

							<!-- button start -->
							<a href="project_drone.html" class="skew-btn js-pointer-large js-animsition-link anim-fade tr-delay-04">
								<span class="skew-btn__box">
