...
<html lang="en">
    ...
    <title>What we do | D'genius Solutions</title>
    <meta name="description" content="D'genius solution brings Digital marketing Solutions that make brands real and relatable." />
					...
					<div class="four-columns column-100-100 padding-top-90">
						<div class="line-col-l-r-margin-20">
							...
							<h2 class="headline-s js-scrollanim js-scrollanim-active">
								<span class="text-color-black">An Extended Caring Note From Our End</span>
								</h2><!-- title end -->
                                                                </div>
					</div><!-- column end -->
