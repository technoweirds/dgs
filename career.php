...
<html lang="en">
    ...
    <title>Digital Marketing Jobs-Career | D'genius Solutions</title>
    <meta name="description" content="Apply to The Latest Job Openings of Digital Marketing Jobs - Employment opportunities in Digital Marketing Jobs for freshers and experienced." />
				...
				<div class="pos-rel flex-min-height-100vh">
					...
					<div class="width-100perc padding-bottom-120">
						...
						<div class="padding-top-120">
							<h2 class="headline-xxl text-center js-scrollanim js-scrollanim-active">
								<span class="anim-slide js-scrollanim">Job Board</span></h2>
                                                        <h3 class="padding-bottom-10 headline-xxs text-center hidden-box">
                                                                 <span class="anim-slide js-scrollanim">Come, join the team of marketing optimists.</span></h3>
                                                <div class="container small padding-top-30">
						<!-- price start -->
						<div class="padding-top-60">
							<div class="flex-container border-box border-radius-10px hidden-box">
								<div class="eight-columns six d-flex flex-align-center">
									<div class="padding-left-40 width-100perc padding-top-bottom-50">
										<!-- list start -->
								...
								<div class="four-columns d-flex flex-center-center">
									<div class="price-btn-offset text-center">
										<a href="application-form.php" target="_blank" class="skew-btn js-pointer-large">
											<span class="skew-btn__box">
												<span class="skew-btn__content">Apply Now</span>
