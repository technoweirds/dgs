			...
			<section id="up" class="pos-rel section-bg-dark-1">
				...
				<div class="pos-rel flex-min-height-100vh">
					<div class="container padding-top-bottom-120 after-preloader-anim">
						...
						<h2 class="subhead-xxl margin-top-20 anim-text-reveal tr-delay-03">A team of passionate marketers who bring tailored & tested solutions to you.<br> 
                                                We plan marketing differently! 
                                                </h2>
					</div>
				</div><!-- pos-rel end -->
