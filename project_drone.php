				...
				<div class="pos-rel flex-min-height-100vh">
					<div class="padding-top-bottom-120 width-100perc after-preloader-anim">
						...
						<h2 class="headline-xxxxl text-center hidden-box">
							<span class="anim-slide">Drone</span>
						</h2><!-- title end -->
			...
			<section class="pos-rel section-bg-light-1" data-midnight="black">
				...
				<div class="pos-rel flex-min-height-100vh">
					...
					<div class="container flex-container padding-top-100 padding-bottom-120">
						...
						<!-- column start -->
						<div class="four-columns column-100-100 padding-top-60">
							<a href="assets/images/projects/drone/pexels-photo-1093236.jpeg" class="column-l-r-margin-10-999 d-block js-pointer-zoom js-photo-popup">
								<img src="assets/images/projects/drone/pexels-photo-1093236.jpeg" alt="project image">
							</a>
						</div><!-- column end -->

						<!-- column start -->
						<div class="four-columns column-100-100 padding-top-60">
							<a href="assets/images/projects/drone/pexels-photo-544491.jpeg" class="column-l-r-margin-10-999 d-block js-pointer-zoom js-photo-popup">
								<img src="assets/images/projects/drone/pexels-photo-544491.jpeg" alt="project image">
							</a>
						</div><!-- column end -->

						<!-- column start -->
						<div class="four-columns column-100-100 padding-top-60">
							<a href="assets/images/projects/drone/air-aircraft-aviate-529598.jpg" class="column-l-r-margin-10-999 d-block js-pointer-zoom js-photo-popup">
								<img src="assets/images/projects/drone/air-aircraft-aviate-529598.jpg" alt="project image">
							</a>
						</div><!-- column end -->
					</div><!-- flex-container end -->
				</div><!-- pos-rel end -->
