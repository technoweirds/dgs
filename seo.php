...
<html lang="en">
    ...
    <title>Search Engine Optimization services | D'genius Solutions</title>
    <meta name="description" content="To increase monthly website traffic, calls, leads, and sales, across the world turn to D'genius solutions for their services SEO (search engine optimization) campaigns." />
    <meta name="keywords" content="seo agency in dubai, best seo company in dubai, best seo companies in mumbai, seo company mumbai, search engine optimization, seo marketing, seo consultant, seo company in ahmedabad, best seo company in ahmedabad, seo services in ahmedabad" />
				...
				<div class="lines-container pos-rel anim-lines flex-min-height-100vh">
					...
					<div class="padding-top-bottom-120 width-100perc">
						...
						<h2 class="headline-xxxl text-center after-preloader-anim">
							<span class="anim-text-fill" data-text="Serach Engine">Serach Engine</span><br>
							<span class="anim-text-fill tr-delay-01" data-text=" Optimization">Optimization</span>
						</h2><!-- title end -->
					...
					<div class="four-columns column-100-100 padding-top-90">
						<div class="line-col-l-r-margin-20">
							...
							<h2 class="headline-s js-scrollanim js-scrollanim-active">
								<span class="text-color-black">SEO</span>
								</h2><!-- title end -->
                                                                </div>
					</div><!-- column end -->
						...
						<div class="padding-top-90 grid-item-50-50-100 js-isotope-grid-item">
							...
							<div class="grid-margin-box js-scrollanim">
								<div class="anim-fade">
									...
									<h3 class="headline-xxs text-color-black margin-top-30">Why should you implement an SEO strategy?</h3>
									<p class="body-text-xs text-color-black margin-top-20">SEO- Search engine optimization is the art and science combined to bring traffic to your website by ranking your brand on any search platforms.</p>
								</div>
						...
						<div class="padding-top-90 grid-item-50-50-100 js-isotope-grid-item">
							...
							<div class="grid-margin-box js-scrollanim">
								<div class="anim-fade">
									...
									<h3 class="headline-xxs text-color-black margin-top-30">A vigorous strategy is the one that</h3>
									<!-- list start -->
								<ul class="list text-color-black margin-top-30 js-scrollanim">
									<li class="list__item red dot hidden-box">
										<div class="body-text-s anim-slide">Increases traffic</div>
									</li>
									<li class="list__item red dot hidden-box">
										<div class="body-text-s anim-slide tr-delay-01">Conversions</div>
									</li>
									<li class="list__item red dot hidden-box">
										<div class="body-text-s anim-slide tr-delay-02">Visibility</div>
									</li>
									<li class="list__item red dot hidden-box">
										<div class="body-text-s anim-slide tr-delay-03">Get higher ranking</div>
									</li>
									<li class="list__item red dot hidden-box">
										<div class="body-text-s anim-slide tr-delay-04">Retarget for resales</div>
									</li>
									<li class="list__item red dot hidden-box">
										<div class="body-text-s anim-slide tr-delay-05">Better user-experience through easy and quick search</div>
									</li>
                                                                        <li class="list__item red dot hidden-box">
										<div class="body-text-s anim-slide tr-delay-05">Cost effective customer pulling</div>
									</li>
									</ul><!-- list end -->
								</div>
							</div><!-- grid-margin-box end -->
						...
						<div class="padding-top-90 grid-item-50-50-100 js-isotope-grid-item">
							...
							<div class="grid-margin-box js-scrollanim">
								<div class="anim-fade">
									...
									<h3 class="headline-xxs text-color-black margin-top-30">Campaigns</h3>
									<p class="body-text-xs text-color-black margin-top-20">We at DGenius specialize in developing search campaigns that deliver skyrocketing results with keyword search, on page optimization, off page optimization, link building and accurate content reach generation.</p>
								</div>
							</div><!-- grid-margin-box end -->
						</div><!-- grid-item end -->
                               ...
                               <div class="pos-rel section-bg-dark-2 padding-top-bottom-40">
				<img class="pos-rel bg-img-cover" src="assets/images/backgrounds/seo proocess.png" alt="development">	
				</div>
			</section><!-- about end -->
