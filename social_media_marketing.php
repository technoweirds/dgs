...
<html lang="en">
    ...
    <meta name="description" content="Social media marketing services help you increase your ROI from social media platforms like Facebook, LinkedIn, Instagram, and Twitter." />
    <meta name="keywords" content="social media marketing agency, social media agency in mumbai, social media marketing services in mumbai, social media agency in dubai, social media services in dubai, social media agency in ahmedabad, social media company in ahmedabad, social media in marketing strategy, social campaign, social media marketing services," />
			...
			<section id="up" class="lines-section pos-rel anim-lines js-parallax-bg" style="background-image:url(assets/images/backgrounds/white-and-brown-vases-2789545.jpg)">
				...
				<div class="lines-container pos-rel anim-lines flex-min-height-100vh">
					...
					<div class="padding-top-bottom-120 width-100perc">
						<!-- title start -->
						<h1 class="headline-xxxl text-center after-preloader-anim">
							<span class="anim-text-fill" data-text="Social Media Marketing">Social Media Marketing</span><br>
							<span class="anim-text-fill tr-delay-01" data-text="& Internet Advertising">& Internet Advertising</span>
							</h1><!-- title end -->
				...
				<div class="flex-container lines-container pos-rel black-lines padding-top-30 padding-bottom-120">
					...
					<div class="four-columns column-100-100 padding-top-90">
						<div class="line-col-l-r-margin-20">
							<!-- title start -->
							<h2 class="headline-s js-scrollanim js-scrollanim-active">
								<span class="text-color-black">Social Media Marketing</span>
								<span class="text-color-black tr-delay-02">& Internet Advertising</span>
								</h2><!-- title end -->
							</div>
					</div><!-- column end -->
					<!-- column start -->
						...
						<div class="padding-top-90 grid-item-50-50-100 js-isotope-grid-item">
							...
							<div class="grid-margin-box text-right js-scrollanim">
								<div class="anim-fade">
									...
									<h3 class="headline-xxs text-color-black margin-top-30">Worldwide Standard</h3>
									<p class="body-text-xs text-color-black margin-top-20">Innovation based comprehensive set of services and solutions to help any company build their advertising effort from scratch into worldwide standard.</p>
								</div>
						...
						<div class="padding-top-90 grid-item-50-50-100 js-isotope-grid-item">
							...
							<div class="grid-margin-box js-scrollanim">
								<div class="anim-fade">
									...
									<h3 class="headline-xxs text-color-black margin-top-30">Key To Success</h3>
									<p class="body-text-xs text-color-black margin-top-20">The key to a successful social media marketing promotion is the right use of social media and social network together at the right time. By right time we mean on a daily basis. The base to successfully executing social media strategies has always been the effective push of marketing campaigns built on a robust and data driven strategy. These strategies help us gain traffic, attention and promote your business to a wider audience.</p>
								</div>
							</div><!-- grid-margin-box end -->
						</div><!-- grid-item end -->
						...
						<div class="padding-top-90 grid-item-50-50-100 js-isotope-grid-item">
							...
							<div class="grid-margin-box text-right js-scrollanim">
								<div class="anim-fade">
									...
									<h3 class="headline-xxs text-color-black margin-top-30">Marketing Strategies</h3>
									<p class="body-text-xs text-color-black margin-top-20">With a careful analysis on a day to day basis we can achieve effective, sustainable and brand oriented (B2B or B2C) marketing strategies.</p>
								</div>
							</div><!-- grid-margin-box end -->
						</div><!-- grid-item end -->
						...
						<div class="padding-top-90 grid-item-50-50-100 js-isotope-grid-item">
							...
							<div class="grid-margin-box js-scrollanim">
								<div class="anim-fade">
									...
									<h3 class="headline-xxs text-color-black margin-top-30">Social Platforms</h3>
									<p class="body-text-xs text-color-black margin-top-20">FB, insta, twitter, LinkedIn, pinterest and youtube.</p>
								</div>
								</div><!-- grid-margin-box end -->
					</div><!-- grid-item end -->
                                       </div><!-- column end -->
