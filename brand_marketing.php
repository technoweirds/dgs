...
<html lang="en">
    ...
    <title>Brand Marketing | D'genius Solutions</title>
    <meta name="description" content="DGS provides analysis and creative solutions with brand marketing expertise to help brand sell/promote their products to the masses." />
				...
				<div class="lines-container pos-rel anim-lines flex-min-height-100vh">
					...
					<div class="padding-top-bottom-120 width-100perc">
						...
						<h1 class="headline-xxxl text-center after-preloader-anim">
							<span class="anim-text-fill" data-text="Brand">Brand</span>
							<span class="anim-text-fill tr-delay-01" data-text="Marketing">Marketing</span>
							</h1><!-- title end -->
					...
					<div class="four-columns column-100-100 padding-top-90">
						<div class="line-col-l-r-margin-20">
							...
							<h2 class="headline-s js-scrollanim">
								<span class="text-color-black" data-text="Brand">Brand</span><br>
								<span class="anim-text-fill tr-delay-01 text-color-black" data-text="Marketing">Marketing</span>
									</h2><!-- title end -->
                                                   	</div>
					</div><!-- column end -->
						...
						<div class="padding-top-90 grid-item-50-50-100 js-isotope-grid-item">
							...
							<div class="grid-margin-box text-right js-scrollanim">
								<div class="anim-fade">
									...
									<h3 class="headline-xxs text-color-black margin-top-30">Brand Consultancy</h3>
									<p class="body-text-xs text-color-black margin-top-20">DGS provides analysis and creative solutions with marketing expertise to help brand sell/promote their products to the masses. This process involves the implementation of various strategies suitable to the brand ethics to drive sales and recognition in agility.</p>
								</div>
						...
						<div class="padding-top-90 grid-item-50-50-100 js-isotope-grid-item">
							...
							<div class="grid-margin-box js-scrollanim">
								<div class="anim-fade">
									...
									<h3 class="headline-xxs text-color-black margin-top-30">Brand Positioning</h3>
									<p class="body-text-xs text-color-black margin-top-20">We help you create a brand positioned successfully to reach its maximum audience capacity that creates market sales opportunities. We redefine your communication across various platforms that springs opportunities for your brand in a future growth direction.</p>
								</div>
							</div><!-- grid-margin-box end -->
						</div><!-- grid-item end -->
						...
						<div class="padding-top-90 grid-item-50-50-100 js-isotope-grid-item">
							...
							<div class="grid-margin-box text-right js-scrollanim">
								<div class="anim-fade">
									...
									<h3 class="headline-xxs text-color-black margin-top-30">Brand Strategy</h3>
									<p class="body-text-xs text-color-black margin-top-20">Unlike a conventional monthly plan, we at DGS set quarterly and half-yearly goals and vision. Brand strategy is the use of data that is used to drive you into your future growth with an amalgamation of creativity, strategy and execution. These strategies will help the brand shoot further than target, making you always achieve a step ahead in business.</p>
							</div>
							</div><!-- grid-margin-box end -->
						</div><!-- grid-item end -->
