		...
		<main class="js-animsition-overlay" data-animsition-overlay="true">
				...
				<div class="pos-rel flex-min-height-100vh">
					...
					<div class="container padding-top-bottom-120">
						<h2 class="headline-xxs text-color-black hidden-box">
							<span class="anim-slide js-scrollanim">Scenester paleo knausgaard organic</span>
						</h2>
						...
						<div class="flex-container padding-top-30">
							...
							<div class="four-columns column-100-100 padding-top-60">
								<div class="column-r-margin-40-999">
									<!-- list start -->
									<ul class="list list_counter list_margin-20px text-color-6d6d6d js-scrollanim">
										<li class="list__item black opacity-05 hidden-box">
											<p class="subhead-xs anim-slide">Awwwwards x2</p>
										</li>
										<li class="list__item black opacity-05 hidden-box">
											<p class="subhead-xs anim-slide tr-delay-01">Behance x24</p>
										</li>
										<li class="list__item black opacity-05 hidden-box">
											<p class="subhead-xs anim-slide tr-delay-02">Best agency x3</p>
										</li>
										<li class="list__item black opacity-05 hidden-box">
											<p class="subhead-xs anim-slide tr-delay-03">Agency of the year x2</p>
										</li>
										<li class="list__item black opacity-05 hidden-box">
											<p class="subhead-xs anim-slide tr-delay-04">CSSDA x4</p>
										</li>
										<li class="list__item black opacity-05 hidden-box">
											<p class="subhead-xs anim-slide tr-delay-05">FWA x5</p>
										</li>
										<li class="list__item black opacity-05 hidden-box">
											<p class="subhead-xs anim-slide tr-delay-06">Best services</p>
										</li>
									</ul><!-- list end -->
								</div>
							</div><!-- column end -->
				...
				<div class="pos-rel padding-top-bottom-120">
					...
					<div class="container">
						...
						<div class="flex-container flex-align-center padding-top-80">
							<div class="three-offset five-columns column-50-100 padding-top-20">
								<div class="column-r-margin-40">
									<div class="anim-overlay js-scrollanim">
										<img src="assets/images/team/team_who-we-are/photo-of-man-wearing-fedora-2179397.jpg" alt="Curtis Schubert">
									</div>
								</div>
							</div>
							<div class="four-columns column-50-100 padding-top-20">
								<div class="js-scrollanim">
									<h4 class="headline-s">
										<span class="anim-text-double-fill" data-text="Curtis">Curtis</span><br>
										<span class="anim-text-double-fill tr-delay-01" data-text="Schubert">Schubert</span>
									</h4>
									<p class="subhead-s margin-top-10 anim-text-double-fill invert tr-delay-02" data-text="Creative director">Creative director</p>
								</div>
							</div>
						</div><!-- flex-container end -->
						...
						<div class="flex-container flex-align-center padding-top-80">
							<div class="one-offset five-columns column-50-100 padding-top-20">
								<div class="column-r-margin-40">
									<div class="anim-overlay js-scrollanim">
										<img src="assets/images/team/team_who-we-are/blur-boy-casual-close-up-428333.jpg" alt="Jimmy Montgomery">
									</div>
								</div>
							</div>
							<div class="four-columns column-50-100 padding-top-20">
								<div class="js-scrollanim">
									<h4 class="headline-s">
										<span class="anim-text-double-fill" data-text="Jimmy">Jimmy</span><br>
										<span class="anim-text-double-fill tr-delay-01" data-text="Montgomery">Montgomery</span>
									</h4>
									<p class="subhead-s margin-top-10 anim-text-double-fill invert tr-delay-02" data-text="Back-end Developer">Back-end Developer</p>
								</div>
							</div>
						</div><!-- flex-container end -->
						...
						<!-- flex-container start -->
						<div class="flex-container flex-align-center padding-top-80">
							<div class="two-offset five-columns column-50-100 padding-top-20">
								<div class="column-r-margin-40">
									<div class="anim-overlay js-scrollanim">
										<img src="assets/images/team/team_who-we-are/adult-dark-facial-expression-fashion-428340.jpg" alt="Jason Winebarger">
									</div>
								</div>
							</div>
							<div class="four-columns column-50-100 padding-top-20">
								<div class="js-scrollanim">
									<h4 class="headline-s">
										<span class="anim-text-double-fill" data-text="Jason">Jason</span><br>
										<span class="anim-text-double-fill tr-delay-01" data-text="Winebarger">Winebarger</span>
									</h4>
									<p class="subhead-s margin-top-10 anim-text-double-fill invert tr-delay-02" data-text="Front-end Developer">Front-end Developer</p>
								</div>
							</div>
						</div><!-- flex-container end -->
						...
						<!-- flex-container start -->
						<div class="flex-container flex-align-center padding-top-80">
							<div class="five-columns column-50-100 padding-top-20">
								<div class="column-r-margin-40">
									<div class="anim-overlay js-scrollanim">
										<img src="assets/images/team/team_who-we-are/woman-posing-for-photo-shoot-1689731.jpg" alt="Nieves Holbert">
									</div>
								</div>
							</div>
							<div class="four-columns column-50-100 padding-top-20">
								<div class="js-scrollanim">
									<h4 class="headline-s">
										<span class="anim-text-double-fill" data-text="Nieves">Nieves</span><br>
										<span class="anim-text-double-fill tr-delay-01" data-text="Holbert">Holbert</span>
									</h4>
									<p class="subhead-s margin-top-10 anim-text-double-fill invert tr-delay-02" data-text="UI/UX Designer">UI/UX Designer</p>
								</div>
							</div>
						</div><!-- flex-container end -->
					</div><!-- container end -->
			...
			<section class="pos-rel section-bg-light-1" data-midnight="black">
				...
				<div class="pos-rel flex-min-height-100vh">
					...
					<div class="container padding-top-bottom-120">
						<h2 class="headline-xxs text-color-black hidden-box">
							<span class="anim-slide js-scrollanim">Artisan wolf copper mug raw denim</span>
						</h2>
						...
						<div class="flex-container padding-top-30">
							...
							<div class="four-columns column-100-100 padding-top-60">
								<div class="column-r-margin-40-999">
									<!-- list start -->
									<ul class="list list_margin-20px text-color-6d6d6d js-scrollanim">
										<li class="list__item dot black hidden-box">
											<p class="subhead-xs anim-slide">Logo Design</p>
										</li>
										<li class="list__item dot black hidden-box">
											<p class="subhead-xs anim-slide tr-delay-01">Strategy</p>
										</li>
										<li class="list__item dot black hidden-box">
											<p class="subhead-xs anim-slide tr-delay-02">Branding</p>
										</li>
										<li class="list__item dot black hidden-box">
											<p class="subhead-xs anim-slide tr-delay-03">Marketing</p>
										</li>
										<li class="list__item dot black hidden-box">
											<p class="subhead-xs anim-slide tr-delay-04">Art Direction</p>
										</li>
										<li class="list__item dot black hidden-box">
											<p class="subhead-xs anim-slide tr-delay-05">Front End</p>
										</li>
										<li class="list__item dot black hidden-box">
											<p class="subhead-xs anim-slide tr-delay-06">Back End</p>
										</li>
									</ul><!-- list end -->
								</div>
							</div><!-- column end -->
							...
							<!-- column start -->
							<div class="eight-columns column-100-100 padding-top-60">
								<p class="body-text-l text-color-black anim-text-reveal js-scrollanim">Brunch vinyl DIY crucifix taxidermy affogato cred selvage quinoa direct trade keytar sustainable shabby chic intelligentsia kombucha. Blog shoreditch food truck aesthetic. Artisan wolf copper mug raw denim, green juice cardigan listicle paleo la croix live-edge four dollar toast sartorial mustache banh mi mlkshk. Hexagon hella four dollar toast +1 gentrify farm-to-table. IPhone franzen portland cardigan fixie blog.</p>
								<!-- list start -->
								<ul class="list list_margin-20px padding-top-60 js-scrollanim">
									<!-- progress-box start -->
									<li class="list__item progress-bar">
										<div class="headline-xxxxs text-color-6d6d6d anim-text-fill" data-text="Web Development">Web Development</div>
									...
									<!-- progress-box start -->
									<li class="list__item progress-bar">
										<div class="headline-xxxxs text-color-6d6d6d anim-text-fill tr-delay-01" data-text="UI/UX Design">UI/UX Design</div>
									...
									<!-- progress-box start -->
									<li class="list__item progress-bar">
										<div class="headline-xxxxs text-color-6d6d6d anim-text-fill tr-delay-02" data-text="Brand Strategy">Brand Strategy</div>
									...
									<!-- progress-box start -->
									<li class="list__item progress-bar">
										<div class="headline-xxxxs text-color-6d6d6d anim-text-fill tr-delay-03" data-text="Motion Design">Motion Design</div>
									...
									<!-- progress-box start -->
									<li class="list__item progress-bar">
										<div class="headline-xxxxs text-color-6d6d6d anim-text-fill tr-delay-04" data-text="Graphic Design">Graphic Design</div>
					...
					<div class="container padding-top-bottom-120">
						...
						<div class="flex-container flex-justify-center padding-top-30">
							...
							<div class="four-columns column-100-100 padding-top-60">
								<div class="column-l-r-margin-10-999 text-center">
									<div class="awards-logo">
										<img class="awards-logo__inner" src="assets/images/awards/fire-awards.png" alt="awards">
									</div>
									<h3 class="headline-xxxs margin-top-30">Fire Awards X2</h3>
									<ul class="list margin-top-20 text-color-b0b0b0 subhead-xxs">
										<li class="list__item">
											<p>Best digital agency</p>
										</li>
										<li class="list__item">
											<p>Best creative agency</p>
										</li>
									</ul>
								</div>
							</div><!-- column end -->
							...
							<div class="four-columns column-100-100 padding-top-60">
								<div class="column-l-r-margin-10-999 text-center">
									<div class="awards-logo">
										<img class="awards-logo__inner" src="assets/images/awards/me-awards.png" alt="awards">
									</div>
									<h3 class="headline-xxxs margin-top-30">ME Awards X3</h3>
									<ul class="list margin-top-20 text-color-b0b0b0 subhead-xxs">
										<li class="list__item">
											<p>Best graphic design</p>
										</li>
										<li class="list__item">
											<p>Best UI design</p>
										</li>
							...
							<div class="four-columns column-100-100 padding-top-60">
								<div class="column-l-r-margin-10-999 text-center">
									<div class="awards-logo">
										<img class="awards-logo__inner" src="assets/images/awards/superstar.png" alt="awards">
									</div>
									<h3 class="headline-xxxs margin-top-30">Superstars X2</h3>
									<ul class="list margin-top-20 text-color-b0b0b0 subhead-xxs">
										<li class="list__item">
											<p>Agency of the year</p>
										</li>
										<li class="list__item">
											<p>Best creative team</p>
										</li>
									</ul>
								</div>
							</div><!-- column end -->
							...
							<div class="four-columns column-100-100 padding-top-60">
								<div class="column-l-r-margin-10-999 text-center">
									<div class="awards-logo">
										<img class="awards-logo__inner" src="assets/images/awards/security-awards.png" alt="awards">
									</div>
									<h3 class="headline-xxxs margin-top-30">Security Awards X2</h3>
									<ul class="list margin-top-20 text-color-b0b0b0 subhead-xxs">
										<li class="list__item">
											<p>Best website</p>
										</li>
							...
							<div class="four-columns column-100-100 padding-top-60">
								<div class="column-l-r-margin-10-999 text-center">
									<div class="awards-logo">
										<img class="awards-logo__inner" src="assets/images/awards/urban-awards.png" alt="awards">
									</div>
									<h3 class="headline-xxxs margin-top-30">Urban Awards X2</h3>
									<ul class="list margin-top-20 text-color-b0b0b0 subhead-xxs">
										<li class="list__item">
											<p>Best branding</p>
										</li>
				...
				<div class="pos-rel flex-min-height-100vh">
					...
					<div class="container padding-top-bottom-120">
						<h2 class="headline-xxs hidden-box">
							<span class="anim-slide js-scrollanim">Blue bottle hashtag schlitz etsy</span>
						</h2>
						...
						<div class="flex-container padding-top-30">
							...
							<div class="four-columns column-100-100 padding-top-60">
								<div class="column-r-margin-40-999">
									<!-- list start -->
									<ul class="list list_margin-20px text-color-b0b0b0 js-scrollanim">
										<li class="list__item dot hidden-box">
											<p class="subhead-xs anim-slide">Identity</p>
										</li>
										<li class="list__item dot hidden-box">
											<p class="subhead-xs anim-slide tr-delay-01">Content</p>
										</li>
										<li class="list__item dot hidden-box">
											<p class="subhead-xs anim-slide tr-delay-02">Website</p>
										</li>
										<li class="list__item dot hidden-box">
											<p class="subhead-xs anim-slide tr-delay-03">Automation</p>
										</li>
										<li class="list__item dot hidden-box">
											<p class="subhead-xs anim-slide tr-delay-04">Design</p>
										</li>
										<li class="list__item dot hidden-box">
											<p class="subhead-xs anim-slide tr-delay-05">Optimisation</p>
										</li>
										<li class="list__item dot hidden-box">
											<p class="subhead-xs anim-slide tr-delay-06">Branding</p>
										</li>
									</ul><!-- list end -->
								</div>
							</div><!-- column end -->
							...
							<div class="eight-columns column-100-100 padding-top-60">
								...
								<div class="accordion accordion_underline js-accordion js-accordion-first-active">
									...
									<div class="accordion__tab js-accordion-tab">
										<div class="accordion__btn js-accordion-btn js-pointer-large">
											<h6 class="accordion__btn-title headline-xxxs margin-top-bottom-20">Back-end Development</h6>
										</div>
										<div class="accordion__content js-accordion-content">
											<p class="body-text-s">Pinterest lumbersexual forage chillwave godard pitchfork vexillologist deep v chia truffaut four dollar toast food truck meditation. Hot chicken coloring book cliche YOLO, crucifix kale chips swag hexagon raclette paleo next level austin.<br><br>Hammock sriracha paleo, iPhone swag af flexitarian hella pickled neutra pug. Trust fund chicharrones iPhone stumptown chia. Godard 3 wolf moon tacos try-hard, raw denim locavore messenger bag portland. Blue bottle hashtag schlitz etsy knausgaard, aesthetic tacos freegan lomo deep v fashion axe.</p>
										</div>
									...
									<div class="accordion__tab js-accordion-tab">
										<div class="accordion__btn js-accordion-btn js-pointer-large">
											<h6 class="accordion__btn-title headline-xxxs margin-top-bottom-20">SEO Optimization</h6>
										</div>
										<div class="accordion__content js-accordion-content">
											<p class="body-text-s">Pinterest lumbersexual forage chillwave godard pitchfork vexillologist deep v chia truffaut four dollar toast food truck meditation. Hot chicken coloring book cliche YOLO, crucifix kale chips swag hexagon raclette paleo next level austin.<br><br>Hammock sriracha paleo, iPhone swag af flexitarian hella pickled neutra pug. Trust fund chicharrones iPhone stumptown chia. Godard 3 wolf moon tacos try-hard, raw denim locavore messenger bag portland. Blue bottle hashtag schlitz etsy knausgaard, aesthetic tacos freegan lomo deep v fashion axe.</p>
										</div>
									...
									<div class="accordion__tab js-accordion-tab">
										<div class="accordion__btn js-accordion-btn js-pointer-large">
											<h6 class="accordion__btn-title headline-xxxs margin-top-bottom-20">Social Media Marketing</h6>
										</div>
										<div class="accordion__content js-accordion-content">
											<p class="body-text-s">Pinterest lumbersexual forage chillwave godard pitchfork vexillologist deep v chia truffaut four dollar toast food truck meditation. Hot chicken coloring book cliche YOLO, crucifix kale chips swag hexagon raclette paleo next level austin.<br><br>Hammock sriracha paleo, iPhone swag af flexitarian hella pickled neutra pug. Trust fund chicharrones iPhone stumptown chia. Godard 3 wolf moon tacos try-hard, raw denim locavore messenger bag portland. Blue bottle hashtag schlitz etsy knausgaard, aesthetic tacos freegan lomo deep v fashion axe.</p>
										</div>
					...
					<div class="padding-top-bottom-120 container">
						...
						<div class="clients-lines">
							...
							<div class="clients-lines__column">
								<div class="clients-lines__inner black hover-box pos-rel">
							...
							<a href="#" class="clients-lines__column js-pointer-large">
								<div class="clients-lines__inner black hover-box pos-rel js-scrollanim">
